/*!  10-05-2014 */ ! function(a, b, c) {
	"use strict";
	b.module("ngAnimate", ["ng"])
			...
			function(d, e) {
				...
				d.decorator("$animate", ["$delegate", "$injector", "$sniffer", "$rootElement", "$timeout", "$rootScope", "$document",
					function(a, c, d, k, o, p) {
						...
						function r(a, b, c, d, e, g, j) {
							function k(a) {
								if (r(), a === !0) return void s();
								var b = c.data(l);
								b && (b.done = s, c.data(l, b)), n(E, "after", s)
							}
							...
							function n(d, e, f) {
								...
								i(d, function(d, f) {
									...
									return "before" != e || "enter" != a && "move" != a ? void(d[e] ? d[j] = C ? d[e](c, b, h) : d[e](c, h) : h()) : void h()
								})
							}
							...
							function s() {
								if (!s.hasBeenRun) {
									s.hasBeenRun = !0;
									var a = c.data(l);
									a && (C ? u(c) : (a.closeAnimationTimeout = o(function() {
										u(c)
									}, 0, !1), c.data(l, a))), p()
								}
							}
							var w, y, z = f(c);
							if (z && (w = z.className, y = w + " " + b), !z || !x(y)) return r(), void s();
							var A = (" " + y)
								.replace(/\s+/g, ".");
							d || (d = e ? e.parent() : c.parent());
							var B = q(A),
								C = "addClass" == a || "removeClass" == a,
								D = c.data(l) || {};
							if (v(c, d) || 0 === B.length) return r(), void s();
							var E = [];
							if (D.running && C && D.structural || i(B, function(d) {
								if (!d.allowCancel || d.allowCancel(c, a, b)) {
									var e, f = d[a];
									"leave" == a ? (e = f, f = null) : e = d["before" + a.charAt(0)
										.toUpperCase() + a.substr(1)], E.push({
										before: e,
										after: f
									})
								}
							}), 0 === E.length) return r(), void p();
							var F = " " + w + " ";
							D.running && (o.cancel(D.closeAnimationTimeout), u(c), t(D.animations), D.beforeComplete ? (D.done || h)(!0) : C && !D.structural && (F = "removeClass" == D.event ? F.replace(D.className, "") : F + D.className + " "));
							var G = " " + b + " ";
							return "addClass" == a && F.indexOf(G) >= 0 || "removeClass" == a && -1 == F.indexOf(G) ? (r(), void p()) : (c.addClass(m), c.data(l, {
								running: !0,
								event: a,
								className: b,
								structural: !C,
						...
						function t(a) {
							var b = !0;
							i(a, function(c) {
								a.beforeComplete || (c.beforeEnd || h)(b), a.afterComplete || (c.afterEnd || h)(b)
							})
						}
						...
						return {
							enter: function(b, c, d, e) {
								this.enabled(!1, b), a.enter(b, c, d), p.$$postDigest(function() {
									r("enter", "ng-enter", b, c, d, h, e)
								})
							},
							leave: function(b, c) {
								s(b), this.enabled(!1, b), p.$$postDigest(function() {
									r("leave", "ng-leave", b, null, null, function() {
										a.leave(b)
									}, c)
								})
							},
							move: function(b, c, d, e) {
								s(b), this.enabled(!1, b), a.move(b, c, d), p.$$postDigest(function() {
									r("move", "ng-move", b, c, d, h, e)
								})
							},
							addClass: function(b, c, d) {
								r("addClass", c, b, null, null, function() {
									a.addClass(b, c)
								}, d)
							},
							removeClass: function(b, c, d) {
								r("removeClass", c, b, null, null, function() {
									a.removeClass(b, c)
								}, d)
							},
					...
					function(d, e, g) {
						function j(a, c) {
							g.cancel(G), T.push(c);
							var d = f(a);
							a = b.element(d), U.push(a);
							var e = a.data(M);
							V = Math.max(V, (e.maxDelay + e.maxDuration) * O * P), e.animationCount = Q, G = g(function() {
								i(T, function(a) {
									a()
								});
								var a = [],
							...
							if (!c) {
								...
								i(a, function(a) {
									if (a.nodeType == k) {
										...
										g = b[B + H], j = Math.max(n(g), j), h = b[B + I], e = b[B + J], l = Math.max(n(e), l), f = b[D + J], o = Math.max(n(f), o);
										var c = n(b[D + H]);
										c > 0 && (c *= parseInt(b[D + K], 10) || 1), m = Math.max(c, m)
									}
								}), c = {
									total: 0,
						...
						function p(a, b) {
							...
							if (f > 0) {
								var g = b + "-stagger",
									h = c + " " + g,
									j = !R[h];
								j && a.addClass(g), e = m(a, h), j && a.removeClass(g)
							}
							a.addClass(b);
							var k = m(a, d),
								l = Math.max(k.transitionDelay, k.animationDelay),
								n = Math.max(k.transitionDuration, k.animationDuration);
							if (0 === n) return a.removeClass(b), !1;
							var p = "";
							return k.transitionDuration > 0 ? q(a) : r(a), i(b.split(" "), function(a, b) {
								p += (b > 0 ? " " : "") + a + "-active"
							}), a.data(M, {
								className: b,
								activeClassName: p,
						...
						function u(a, b, c) {
							function d() {
								a.off(o, e), a.removeClass(l), z(a, b);
								var c = f(a);
							...
							function e(a) {
								...
								var b = a.originalEvent || a,
									...
									e = parseFloat(b.elapsedTime.toFixed(N));
							...
							var i = g.timings,
								...
								k = g.maxDuration,
								l = g.activeClassName,
								m = Math.max(i.transitionDelay, i.animationDelay) * P,
								n = Date.now(),
								o = E + " " + C,
								p = g.ii,
								q = "",
							...
							if (i.transitionDuration > 0) {
								var s = i.transitionPropertyStyle; - 1 == s.indexOf("all") && (q += F + "transition-property: " + s + ";", q += F + "transition-duration: " + i.transitionDurationStyle + "s;", r.push(F + "transition-property"), r.push(F + "transition-duration"))
							}
							if (p > 0) {
								if (j.transitionDelay > 0 && 0 === j.transitionDuration) {
									var t = i.transitionDelayStyle;
									q += F + "transition-delay: " + v(t, j.transitionDelay, p) + "; ", r.push(F + "transition-delay")
								}
								j.animationDelay > 0 && 0 === j.animationDuration && (q += F + "animation-delay: " + v(i.animationDelayStyle, j.animationDelay, p) + "; ", r.push(F + "animation-delay"))
							}
							if (r.length > 0) {
						...
						function w(a, b) {
							return p(a, b) ? function(c) {
								c && z(a, b)
							} : void 0
						}

						function x(a, b, c) {
							return a.data(M) ? u(a, b, c) : (z(a, b), void c())
						}
						...
						function z(a, b) {
							a.removeClass(b), a.removeData(M)
						}
						...
						return {
							allowCancel: function(a, c, d) {
								...
								h.addClass(A(d, j)), g.append(h);
								var k = m(h);
								return h.remove(), Math.max(k.transitionDuration, k.animationDuration) > 0
							},
							enter: function(a, b) {
								return y(a, "ng-enter", b)
							},
							leave: function(a, b) {
								return y(a, "ng-leave", b)
							},
							move: function(a, b) {
								return y(a, "ng-move", b)
							},
							beforeAddClass: function(a, b, c) {
								var d = w(a, A(b, "-add"));
								return d ? (j(a, function() {
									s(a), t(a), c()
								}), d) : void c()
							},
							addClass: function(a, b, c) {
								return x(a, A(b, "-add"), c)
							},
							beforeRemoveClass: function(a, b, c) {
								var d = w(a, A(b, "-remove"));
								return d ? (j(a, function() {
									s(a), t(a), c()
								}), d) : void c()
							},
							removeClass: function(a, b, c) {
								return x(a, A(b, "-remove"), c)
							}
						}
					}
				])
		...
		this.when = function(a, e) {
			...
			function(c, e, f, g, h, i, j, k) {
				...
				function m() {
					var a = n(),
						d = q.current;
					a && d && a.$$route === d.$$route && b.equals(a.pathParams, d.pathParams) && !a.reloadOnSearch && !p ? (d.params = a.params, b.copy(d.params, f), c.$broadcast("$routeUpdate", d)) : (a || d) && (p = !1, c.$broadcast("$routeChangeStart", a, d), q.current = a, a && a.redirectTo && (b.isString(a.redirectTo) ? e.path(o(a.redirectTo, a.params))
							.search(a.params)
							.replace() : e.url(a.redirectTo(a.pathParams, e.path(), e.search()))
							.replace()), g.when(a)
						.then(function() {
							if (a) {
		...
		return {
			...
			link: function(d, e) {
				...
				if (f.controller) {
					...
					f.controllerAs && (d[f.controllerAs] = i), e.data("$ngControllerController", i), e.children()
						.data("$ngControllerController", i)
				}
				h(d)
			}
		}
	}
	var g = b.module("ngRoute", ["ng"])
		.provider("$route", c);
...
function(a, b) {
	...
	function f(a, c) {
		...
		for (s.last = function() {
			...
			if (h = !0, s.last() && z[s.last()]) a = a.replace(new RegExp("(.*)<\\s*\\/\\s*" + s.last() + "[^>]*>", "i"), function(a, b) {
				return b = b.replace(p, "$1")
					.replace(r, "$1"), c.chars && c.chars(g(b)), ""
			}), e("", s.last());
	...
	var j = b.$$minErr("$sanitize"),
		...
		E = /^(\s*)([\s\S]*?)(\s*)$/;
	b.module("ngSanitize", [])
		.provider("$sanitize", c), b.module("ngSanitize")
...
function(a, b, c) {
	...
	function d(a) {
		return function() {
			var b, c = arguments[0],
				c = "[" + (a ? a + ":" : "") + c + "] http://errors.angularjs.org/1.2.6/" + (a ? a + "/" : "") + c;
			for (b = 1; b < arguments.length; b++) c = c + (1 == b ? "?" : "&") + "p" + (b - 1) + "=" + encodeURIComponent("function" == typeof arguments[b] ? arguments[b].toString()
				.replace(/ \{[\s\S]*$/, "") : "undefined" == typeof arguments[b] ? "undefined" : "string" != typeof arguments[b] ? JSON.stringify(arguments[b]) : arguments[b]);
			return Error(c)
		}
	}
	...
	function j() {
		for (var a, b = Zc.length; b;) {
			if (b--, a = Zc[b].charCodeAt(0), 57 == a) return Zc[b] = "A", Zc.join("");
			if (90 != a) return Zc[b] = String.fromCharCode(a + 1), Zc.join("");
			Zc[b] = "0"
		}
		return Zc.unshift("0"), Zc.join("")
	}
	...
	function w(a) {
		return "[object Date]" === Wc.call(a)
	}

	function x(a) {
		return "[object Array]" === Wc.call(a)
	}
	...
	function z(a) {
		return "[object RegExp]" === Wc.call(a)
	}
	...
	function F(a, b) {
		if (A(a) || a && a.$evalAsync && a.$watch) throw Xc("cpws");
		if (b) {
			if (a === b) throw Xc("cpi");
			if (x(a))
				for (var c = b.length = 0; c < a.length; c++) b.push(F(a[c]));
			else {
	...
	function H(a, b) {
		...
		if (e == typeof b && "object" == e) {
			if (!x(a)) {
				...
				for (d in b)
					if (!e.hasOwnProperty(d) && "$" !== d.charAt(0) && b[d] !== c && !y(b[d])) return !1;
				return !0
			}
			if (!x(b)) return !1;
	...
	function J(a, b) {
		...
		return !y(b) || b instanceof RegExp ? b : c.length ? function() {
			return arguments.length ? b.apply(a, c.concat(Uc.call(arguments, 0))) : b.apply(a, c)
		} : function() {
	...
	function K(a, d) {
		var e = d;
		return "string" == typeof a && "$" === a.charAt(0) ? e = c : A(d) ? e = "$WINDOW" : d && b === d ? e = "$DOCUMENT" : d && d.$evalAsync && d.$watch && (e = "$SCOPE"), e
	}
	...
	function N(a) {
		return a && 0 !== a.length ? (a = Sc("" + a), a = !("f" == a || "0" == a || "false" == a || "no" == a || "n" == a || "[]" == a)) : a = !1, a
	}
	...
	function O(a) {
		...
		var c = Oc("<div>")
			...
			.html();
		try {
			return 3 === a[0].nodeType ? Sc(c) : c.match(/^(<[^>]+>)/)[1].replace(/^<([\w\-]+)/, function(a, b) {
				return "<" + Sc(b)
			})
		} catch (d) {
			return Sc(c)
	...
	function U(a, c) {
		...
		f(i, function(c) {
			...
			if (!e) {
				...
				b ? (e = a, g = (b[2] || "")
					.replace(/\s+/g, ",")) : f(a.attributes, function(b) {
	...
	function V(c, d) {
		var e = function() {
			if (c = Oc(c), c.injector()) {
				var a = c[0] === b ? "document" : O(c);
				throw Xc("btstrpd", a)
			}
			return d = d || [], d.unshift(["$provide",
				function(a) {
					a.value("$rootElement", c)
				}
			]), d.unshift("ng"), a = wb(d), a.invoke(["$rootScope", "$rootElement", "$compile", "$injector", "$animate",
				function(a, b, c, d) {
					a.$apply(function() {
		...
		return a && !g.test(a.name) ? e() : (a.name = a.name.replace(g, ""), void(Yc.resumeBootstrap = function(a) {
			f(a, function(a) {
				d.push(a)
			}), e()
		}))
	...
	function W(a, b) {
		return b = b || "_", a.replace(_c, function(a, c) {
			return (c ? b : "") + a.toLowerCase()
		})
	}

	function X(a, b, c) {
		if (!a) throw Xc("areq", b || "?", c || "required");
		return a
	}

	function Y(a, b, c) {
		return c && x(a) && (a = a[a.length - 1]), X(y(a), b, "not a function, got " + (a && "object" == typeof a ? a.constructor.name || "Object" : typeof a)), a
	}

	function Z(a, b) {
		if ("hasOwnProperty" === a) throw Xc("badname", b)
	}
	...
	function _(a) {
		var b = a[0];
		if (a = a[a.length - 1], b === a) return Oc(b);
		var c = [b];
		do {
	...
	function bb(a) {
		return a.replace(gd, function(a, b, c, d) {
	...
	function cb(a, b, c, d) {
		function e(a) {
			...
			if (!d || null != a)
				for (; l.length;)
					for (e = l.shift(), g = 0, h = e.length; h > g; g++)
						for (i = Oc(e[g]), m ? i.triggerHandler("$destroy") : m = !m, j = 0, i = (k = i.children())
							.length; i > j; j++) l.push(Pc(k[j]));
			return f.apply(this, arguments)
		}
		var f = Pc.fn[a],
			f = f.$original || f;
		e.$original = f, Pc.fn[a] = e
	}

	function db(a) {
		if (a instanceof db) return a;
		if (!(this instanceof db)) {
			if (u(a) && "<" != a.charAt(0)) throw id("nosel");
			return new db(a)
		}
		if (u(a)) {
			var c = b.createElement("div");
			c.innerHTML = "<div>&#160;</div>" + a, c.removeChild(c.firstChild), nb(this, c.childNodes), Oc(b.createDocumentFragment())
				.append(this)
		} else nb(this, a)
	}
	...
	function gb(a, b, c, d) {
		if (s(d)) throw id("offargs");
		var e = ib(a, "events");
		ib(a, "handle") && (r(b) ? f(e, function(b, c) {
			fd(a, c, b), delete e[c]
		}) : f(b.split(" "), function(b) {
			r(c) ? (fd(a, b, e[b]), delete e[b]) : E(e[b] || [], c)
		}))
	}
	...
	function hb(a, b) {
		var d = a[cd],
			e = bd[d];
		e && (b ? delete bd[d].data[b] : (e.handle && (e.events.$destroy && e.handle({}, "$destroy"), gb(a)), delete bd[d], a[cd] = c))
	}

	function ib(a, b, c) {
		var d = a[cd],
			d = bd[d || -1];
		return s(c) ? (d || (a[cd] = d = ++dd, d = bd[d] = {}), void(d[b] = c)) : d && d[b]
	}
	...
	function lb(a, b) {
		b && a.setAttribute && f(b.split(" "), function(b) {
			a.setAttribute("class", $c((" " + (a.getAttribute("class") || "") + " ")
				.replace(/[\n\t]/g, " ")
				.replace(" " + $c(b) + " ", " ")))
		})
	}
	...
	function mb(a, b) {
		if (b && a.setAttribute) {
			...
			f(b.split(" "), function(a) {
				a = $c(a), -1 === c.indexOf(" " + a + " ") && (c += a + " ")
			}), a.setAttribute("class", $c(c))
		}
	}
	...
	function pb(a, b, d) {
		for (a = Oc(a), 9 == a[0].nodeType && (a = a.find("html")), b = x(b) ? b : [b]; a.length;) {
			for (var e = 0, f = b.length; f > e; e++)
				if ((d = a.data(b[e])) !== c) return d;
			a = a.parent()
		}
	}
	...
	function sb(a, c) {
		var d = function(d, e) {
			...
			f(h, function(b) {
				b.call(a, d)
			}), 8 >= Nc ? (d.preventDefault = null, d.stopPropagation = null, d.isDefaultPrevented = null) : (delete d.preventDefault, delete d.stopPropagation, delete d.isDefaultPrevented)
		};
		return d.elem = a, d
	}
	...
	function vb(a) {
		var b, c;
		return "function" == typeof a ? (b = a.$inject) || (b = [], a.length && (c = a.toString()
			.replace(pd, ""), c = c.match(md), f(c[1].split(nd), function(a) {
				a.replace(od, function(a, c, d) {
					b.push(d)
				})
			})), a.$inject = b) : x(a) ? (c = a.length - 1, Y(a[c], "fn"), b = a.slice(0, c)) : Y(a, "fn", !0), b
	}
	...
	function wb(a) {
		...
		function c(a, b) {
			if (Z(a, "service"), (y(b) || x(b)) && (b = n.instantiate(b)), !b.$get) throw qd("pget", a);
			return m[a + j] = b
		}
		...
		function g(a, b) {
			...
			function d(a, b, d) {
				...
				for (f = 0, e = i.length; e > f; f++) {
					if (g = i[f], "string" != typeof g) throw qd("itkn", g);
			...
			return {
				...
				instantiate: function(a, b) {
					var c, e = function() {};
					return e.prototype = (x(a) ? a[a.length - 1] : a)
						.prototype, e = new e, c = d(a, e, b), t(c) || y(c) ? c : e
				},
				get: c,
				annotate: vb,
				has: function(b) {
	...
	function yb(a, b, d, e) {
		...
		var x = l.href,
			...
			z = null;
		j.url = function(b, c) {
			return l !== a.location && (l = a.location), b ? x != b ? (x = b, e.history ? c ? m.replaceState(null, "", b) : (m.pushState(null, "", b), y.attr("href", y.attr("href"))) : (z = b, c ? l.replace(b) : l.href = b), j) : void 0 : z || l.href.replace(/%27/g, "'")
		};
		var A = [],
			B = !1;
		j.onUrlChange = function(b) {
			return B || (e.history && Oc(a)
				.on("popstate", i), e.hashchange ? Oc(a)
				.on("hashchange", i) : j.addPollFn(i), B = !0), A.push(b), b
		}, j.baseHref = function() {
			var a = y.attr("href");
		...
		j.cookies = function(a, b) {
			...
			if (!a) {
				if (k.cookie !== D)
					for (D = k.cookie, e = D.split("; "), C = {}, g = 0; g < e.length; g++) f = e[g], h = f.indexOf("="), h > 0 && (a = unescape(f.substring(0, h)), C[a] === c && (C[a] = unescape(f.substring(h + 1))));
				return C
			}
			b === c ? k.cookie = escape(a) + "=;path=" + E + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : u(b) && (e = (k.cookie = escape(a) + "=" + escape(b) + ";path=" + E)
				.length + 1, e > 4096 && d.warn("Cookie '" + a + "' possibly not set or overflowed because it was too large (" + e + " > 4096 bytes)!"))
	...
	function Cb(a, d) {
		...
		this.directive = function m(b, c) {
			return Z(b, "directive"), u(b) ? (X(c, "directiveFactory"), e.hasOwnProperty(b) || (e[b] = [], a.factory(b + g, ["$injector", "$exceptionHandler",
				function(a, c) {
					var d = [];
			...
			function(a, d, i, m, o, r, s, v, w, z, A, B) {
				function C(a, b, c, d, e) {
					a instanceof Oc || (a = Oc(a)), f(a, function(b, c) {
						3 == b.nodeType && b.nodeValue.match(/\S+/) && (a[c] = Oc(b)
							.wrap("<span></span>")
							.parent()[0])
					});
					var g = E(a, b, a, c, d, e);
				...
				function E(a, b, d, e, f, g) {
					function h(a, d, e, f) {
						...
						for (n = k = 0, l = m.length; l > k; n++) h = o[n], d = m[k++], g = m[k++], i = Oc(h), d ? (d.scope ? (j = a.$new(), i.data("$scope", j)) : j = a, (i = d.transclude) || !f && b ? d(g, j, h, e, F(a, i || b)) : d(g, j, h, e, f)) : g && g(a, h.childNodes, c, f)
					}
					for (var i, j, k, l, m = [], n = 0; n < a.length; n++) i = new _, j = I(a[n], [], i, 0 === n ? e : c, f), (g = j.length ? M(j, a[n], i, b, d, null, [], [], g) : null) && g.scope && D(Oc(a[n]), "ng-scope"), i = g && g.terminal || !(k = a[n].childNodes) || !k.length ? null : E(k, g ? g.transclude : b), m.push(g, i), l = l || g || i, g = null;
					return l ? h : null
				}
				...
				function F(a, b) {
					return function(c, d, e) {
						var f = !1;
						return c || (c = a.$new(), f = c.$$transcluded = !0), d = b(c, d, e), f && d.on("$destroy", J(c, c.$destroy)), d
					}
				}
					...
					switch (a.nodeType) {
						case 1:
							...
							for (var m = 0, n = f && f.length; n > m; m++) {
								var o = !1,
									p = !1;
								if (i = f[m], !Nc || Nc >= 8 || i.specified) {
									k = i.name, l = Db(k), db.test(l) && (k = W(l.substr(6), "-"));
									var q = l.replace(/(Start|End)$/, "");
									l === q + "Start" && (o = k, p = k.substr(0, k.length - 5) + "end", k = k.substr(0, k.length - 6)), l = Db(k.toLowerCase()), g[l] = k, c[l] = i = $c(i.value), rb(a, l) && (c[l] = !0), Y(a, b, i, l), P(b, l, "A", d, e, o, p)
								}
							}
							if (a = a.className, u(a) && "" !== a)
								for (; f = j.exec(a);) l = Db(f[2]), P(b, l, "C", d, e) && (c[l] = $c(f[3])), a = a.substr(f.index + f[0].length);
							break;
						case 3:
							U(b, a.nodeValue);
							break;
						case 8:
							try {
								(f = h.exec(a.nodeValue)) && (l = Db(f[1]), P(b, l, "M", d, e) && (c[l] = $c(f[2])))
							} catch (r) {}
					}
					return b.sort(S), b
				}
				...
				function M(a, e, g, h, j, k, l, m, n) {
					...
					function p(a, b, c) {
						...
						if (u(a)) {
							...
							if (d = null, c && "data" === e && (d = c[a]), d = d || b[e]("$" + a + "Controller"), !d && !g) throw td("ctreq", a, F)
					...
					function q(a, b, h, j, k) {
						...
						var o, q, t, u, v, w, x, y = {};
						if (o = e === h ? g : G(g, new _(Oc(h), g.$attr)), q = o.$$element, A) {
							var C = /^\s*([@=&])(\??)\s*(\w*)\s*$/;
							j = Oc(h), w = b.$new(!0), B && B === A.$$originalDirective ? j.data("$isolateScope", w) : j.data("$isolateScopeNoTemplate", w), D(j, "ng-isolate-scope"), f(A.scope, function(a, c) {
								var e, f, g, h, i = a.match(C) || [],
									j = i[3] || c,
									k = "?" == i[2],
									i = i[1];
								switch (w.$$isolateBindings[c] = i + j, i) {
									...
									case "=":
										...
										f = r(o[j]), h = f.literal ? H : function(a, b) {
											...
											throw e = w[c] = f(b), td("nonassign", o[j], A.name)
						...
						for (x = k && n, z && f(z, function(a) {
							...
							v = a.controller, "@" == v && (v = o[a.name]), c = s(v, d), y[a.name] = c, S || q.data("$" + a.name + "Controller", c), a.controllerAs && (d.$scope[a.controllerAs] = c)
						}), j = 0, t = l.length; t > j; j++) try {
							(u = l[j])(u.isolateScope ? w : b, q, o, u.require && p(u.require, q, y), x)
						} catch (E) {
							i(E, O(q))
						}
						for (j = b, A && (A.template || null === A.templateUrl) && (j = w), a && a(j, h.childNodes, c, k), j = m.length - 1; j >= 0; j--) try {
					...
					n = n || {};
					var v, w = -Number.MAX_VALUE,
						z = n.controllerDirectives,
						A = n.newIsolateScopeDirective,
						B = n.templateDirective;
					n = n.nonTlbTranscludeDirective;
					for (var E, F, J, M, P = !1, S = !1, U = g.$$element = Oc(e), V = h, W = 0, X = a.length; X > W; W++) {
						E = a[W];
						var Y = E.$$start,
							ab = E.$$end;
						if (Y && (U = K(e, Y, ab)), J = c, w > E.priority) break;
						if ((J = E.scope) && (v = v || E, E.templateUrl || (T("new/isolated scope", A, E, U), t(J) && (A = E))), F = E.name, !E.templateUrl && E.controller && (J = E.controller, z = z || {}, T("'" + F + "' controller", z[F], E, U), z[F] = E), (J = E.transclude) && (P = !0, E.$$tlb || (T("transclusion", n, E, U), n = E), "element" == J ? (S = !0, w = E.priority, J = K(e, Y, ab), U = g.$$element = Oc(b.createComment(" " + F + ": " + g[F] + " ")), e = U[0], Z(j, Oc(Uc.call(J, 0)), e), V = C(J, h, w, k && k.name, {
							nonTlbTranscludeDirective: n
						})) : (J = Oc(eb(e))
							.contents(), U.empty(), V = C(J, h))), E.template)
							if (T("template", B, E, U), B = E, J = y(E.template) ? E.template(U, g) : E.template, J = cb(J), E.replace) {
								if (k = E, J = Oc("<div>" + $c(J) + "</div>")
									.contents(), e = J[0], 1 != J.length || 1 !== e.nodeType) throw td("tplrt", F, "");
								Z(j, U, e), X = {
									$attr: {}
								}, J = I(e, [], X);
								var bb = a.splice(W + 1, a.length - (W + 1));
								A && N(J), a = a.concat(J)
									.concat(bb), Q(g, X), X = a.length
							} else U.html(J);
				...
				function R(a, b, c, d, e, g, h, i) {
					...
					return b.empty(), m.get(z.getTrustedResourceUrl(s), {
						...
						.success(function(l) {
							...
							if (l = cb(l), q.replace) {
								if (l = Oc("<div>" + $c(l) + "</div>")
									.contents(), m = l[0], 1 != l.length || 1 !== m.nodeType) throw td("tplrt", q.name, s);
								l = {
									$attr: {}
								}, Z(d, b, m);
								var u = I(m, [], l);
							...
							for (a.unshift(r), j = M(a, m, c, e, b, q, g, h, i), f(d, function(a, c) {
								...
								var v = n.shift(),
									w = n.shift(),
									u = b[0];
								o !== p && (u = eb(m), Z(v, Oc(o), u)), o = j.transclude ? F(l, j.transclude) : w, j(k, l, u, d, o)
							}
							n = null
						})
						.error(function(a, b, c, d) {
							throw td("tpload", d.url)
						}),
					function(a, b, c, d, e) {
				...
				function Y(a, b, c, e) {
					var f = d(c, !0);
					if (f) {
						if ("multiple" === e && "SELECT" === Rc(a)) throw td("selmulti", O(a));
						b.push({
							priority: 100,
							compile: function() {
								return {
									pre: function(b, c, g) {
										if (c = g.$$observers || (g.$$observers = {}), k.test(e)) throw td("nodomevents");
										(f = d(g[e], !0, V(a, e))) && (g[e] = f(b), (c[e] || (c[e] = []))
											.$$inter = !0, (g.$$observers && g.$$observers[e].$$scope || b)
				...
				function Z(a, c, d) {
					...
					for (i && i.replaceChild(d, g), a = b.createDocumentFragment(), a.appendChild(g), d[Oc.expando] = g[Oc.expando], g = 1, h = c.length; h > g; g++) i = c[g], Oc(i)
						.remove(), a.appendChild(i), delete c[g];
					c[0] = d, c.length = 1
				}
				...
				_.prototype = {
					...
					$set: function(a, b, d, e) {
						...
						g && (this.$$element.prop(a, b), e = g), this[a] = b, e ? this.$attr[a] = e : (e = this.$attr[a]) || (this.$attr[a] = e = W(a, "-")), g = Rc(this.$$element), ("A" === g && "href" === a || "IMG" === g && "src" === a) && (this[a] = b = B(b, "src" === a)), !1 !== d && (null === b || b === c ? this.$$element.removeAttr(e) : this.$$element.attr(e, b)), (d = this.$$observers) && f(d[a], function(a) {
							try {
								a(b)
							} catch (c) {
								i(c)
				...
				var ab = d.startSymbol(),
					bb = d.endSymbol(),
					cb = "{{" == ab || "}}" == bb ? p : function(a) {
						return a.replace(/\{\{/g, ab)
							.replace(/}}/g, bb)
				}, db = /^ngAttr[A-Z]/;
				return C
			}
	...
	function Fb() {
		...
		this.register = function(b, c) {
			...
			function(c, e) {
				return function(f, g) {
					var h, i, j;
					if (u(f) && (h = f.match(b), i = h[1], j = h[3], f = a.hasOwnProperty(i) ? a[i] : $(g.$scope, i, !0) || $(e, i, !0), Y(f, i, !0)), h = c.instantiate(f, g), j) {
	...
	function Ib(a) {
		var b, c, d, e = {};
		return a ? (f(a.split("\n"), function(a) {
			d = a.indexOf(":"), b = Sc($c(a.substr(0, d))), c = $c(a.substr(d + 1)), b && (e[b] = e[b] ? e[b] + (", " + c) : c)
		}), e) : e
	}
	...
	function Jb(a) {
		var b = t(a) ? a : c;
		return function(c) {
			return b || (b = Ib(a)), c ? b[Sc(c)] || null : b
		}
	}
	...
	function Lb() {
		var a = /^\s*(\[|\{[^\{])/,
			...
			e = {
				...
				transformRequest: [
					function(a) {
						return t(a) && "[object File]" !== Wc.call(a) ? L(a) : a
					}
				],
				headers: {
					common: {
		...
		this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector",
			function(a, b, d, e, k, m) {
				function n(a) {
					...
					var e = {
						...
						transformResponse: g.transformResponse
							...
							var c, d, e = g.headers,
								h = l({}, a.headers),
								e = l({}, e.common, e[Sc(a.method)]);
							b(e), b(h);
							a: for (c in e) {
								a = Sc(c);
								for (d in h)
									if (Sc(d) === a) continue a;
								h[c] = e[c]
							}
							return h
						}(a);
					l(e, a), e.headers = h, e.method = Tc(e.method), (a = vc(e.url) ? b.cookies()[e.xsrfCookieName || g.xsrfCookieName] : c) && (h[e.xsrfHeaderName || g.xsrfHeaderName] = a);
					var i = [
						function(a) {
							h = a.headers;
							var b = Kb(a.data, Jb(h), a.transformRequest);
							return r(a.data) && f(h, function(a, b) {
								"content-type" === Sc(b) && delete h[b]
							}), r(a.withCredentials) && !r(g.withCredentials) && (a.withCredentials = g.withCredentials), o(a, b, h)
								.then(d, d)
						},
						c
					],
				...
				function o(b, c, d) {
					function f(a, b, c) {
						j && (a >= 200 && 300 > a ? j.put(u, [a, b, Ib(c)]) : j.remove(u)), h(b, a, c), e.$$phase || e.$apply()
					}
					...
					function i() {
						var a = D(n.pendingRequests, b); - 1 !== a && n.pendingRequests.splice(a, 1)
					}
					var j, l, m = k.defer(),
						o = m.promise,
						u = p(b.url, b.params);
					if (n.pendingRequests.push(b), o.then(i, i), (b.cache || g.cache) && !1 !== b.cache && "GET" == b.method && (j = t(b.cache) ? b.cache : t(g.cache) ? g.cache : q), j)
						if (l = j.get(u), s(l)) {
							if (l.then) return l.then(i, i), l;
							x(l) ? h(l[1], l[0], F(l[2])) : h(l, 200, {})
						} else j.put(u, o);
					return r(l) && a(b.method, u, c, f, d, b.timeout, b.withCredentials, b.responseType), o
				}
	...
	function Mb() {
		this.$get = ["$browser", "$window", "$document",
			function(a, b, c) {
				return Nb(a, vd, a.defer, b.angular.callbacks, c[0])
			}
		]
	}
	...
	function Nb(a, b, c, d, e) {
		function g(a, b) {
			...
			return c.type = "text/javascript", c.src = a, Nc && 8 >= Nc ? c.onreadystatechange = function() {
		...
		return function(e, i, j, k, l, m, n, p) {
			...
			function r(b, d, e, f) {
				var g = uc(i)
					.protocol;
				x && c.cancel(x), v = w = null, d = "file" == g && 0 === d ? e ? 200 : 404 : d, b(1223 == d ? 204 : d, e, f), a.$$completeOutstandingRequest(o)
			}
			var t;
			if (a.$$incOutstandingRequestCount(), i = i || a.url(), "jsonp" == Sc(e)) {
				var u = "_" + (d.counter++)
					.toString(36);
				d[u] = function(a) {
					d[u].data = a
		...
		this.startSymbol = function(b) {
			...
			function(c, d, e) {
				function f(f, i, j) {
					...
					if ((o = n.length) || (n.push(""), o = 1), j && 1 < n.length) throw wd("noconcat", f);
					return !i || p ? (q.length = o, m = function(a) {
						try {
							for (var b, c = 0, g = o; g > c; c++) "function" == typeof(b = n[c]) && (b = b(a), b = j ? e.getTrusted(j, b) : e.valueOf(b), null === b || r(b) ? b = "" : "string" != typeof b && (b = L(b))), q[c] = b;
							return q.join("")
						} catch (h) {
							a = wd("interr", f, h.toString()), d(a)
						}
	...
	function Sb(a, b, c) {
		a = uc(a, c), b.$$protocol = a.protocol, b.$$host = a.hostname, b.$$port = m(a.port) || yd[a.protocol] || null
	}

	function Tb(a, b, c) {
		var d = "/" !== a.charAt(0);
		d && (a = "/" + a), a = uc(a, c), b.$$path = decodeURIComponent(d && "/" === a.pathname.charAt(0) ? a.pathname.substring(1) : a.pathname), b.$$search = Q(a.search), b.$$hash = decodeURIComponent(a.hash), b.$$path && "/" != b.$$path.charAt(0) && (b.$$path = "/" + b.$$path)
	}
	...
	function Xb(a, b) {
		this.$$html5 = !0, b = b || "";
		var d = Wb(a);
		Sb(a, this, a), this.$$parse = function(b) {
			var c = Ub(d, b);
			if (!u(c)) throw zd("ipthprfx", b, d);
			Tb(c, this, a), this.$$path || (this.$$path = "/"), this.$$compose()
			...
			var f;
			return (f = Ub(a, e)) !== c ? (e = f, (f = Ub(b, f)) !== c ? d + (Ub("/", f) || f) : a + e) : (f = Ub(d, e)) !== c ? d + f : d == e + "/" ? d : void 0
		}
	}

	function Yb(a, b) {
		var c = Wb(a);
		Sb(a, this, a), this.$$parse = function(d) {
			var e = Ub(a, d) || Ub(c, d),
				e = "#" == e.charAt(0) ? Ub(b, e) : this.$$html5 ? e : "";
			if (!u(e)) throw zd("ihshprfx", d, b);
			Tb(e, this, a), d = this.$$path;
			var f = /^\/?.*?:(\/.*)/;
			...
			return Vb(a) == Vb(b) ? b : void 0
		}
	}

	function Zb(a, b) {
		this.$$html5 = !0, Yb.apply(this, arguments);
		var c = Wb(a);
		this.$$rewrite = function(d) {
			var e;
			return a == Vb(d) ? d : (e = Ub(c, d)) ? a + b + e : c === d + "/" ? c : void 0
		}
	}
	...
	function ac() {
		...
		this.hashPrefix = function(a) {
			...
			function(d, e, f, g) {
				...
				var i, j = e.baseHref(),
					k = e.url();
				c ? (j = k.substring(0, k.indexOf("/", k.indexOf("//") + 2)) + (j || "/"), f = f.history ? Xb : Zb) : (j = Vb(k), f = Yb), i = new f(j, "#" + b), i.$$parse(i.$$rewrite(k)), g.on("click", function(b) {
					if (!b.ctrlKey && !b.metaKey && 2 != b.which) {
						for (var c = Oc(b.target);
							"a" !== Sc(c[0].nodeName);)
							if (c[0] === g[0] || !(c = c.parent())[0]) return;
						var f = c.prop("href");
						t(f) && "[object SVGAnimatedString]" === f.toString() && (f = uc(f.animVal)
							.href);
						var h = i.$$rewrite(f);
					...
					i.absUrl() != a && (d.$broadcast("$locationChangeStart", a, i.absUrl())
						.defaultPrevented ? e.url(i.absUrl()) : (d.$evalAsync(function() {
							var b = i.absUrl();
							i.$$parse(a), h(b)
						}), d.$$phase || d.$digest()))
				});
				...
				return d.$watch(function() {
					...
					return l && a == i.absUrl() || (l++, d.$evalAsync(function() {
						d.$broadcast("$locationChangeStart", i.absUrl(), a)
							.defaultPrevented ? i.$$parse(a) : (e.url(i.absUrl(), b), h(a))
					})), i.$$replace = !1, l
				}), i
			}
		]
	...
	function cc(a, b) {
		if ("constructor" === a) throw Bd("isecfld", b);
		return a
	}

	function dc(a, b) {
		if (a) {
			if (a.constructor === a) throw Bd("isecfn", b);
			if (a.document && a.location && a.alert && a.setInterval) throw Bd("isecwindow", b);
			if (a.children && (a.nodeName || a.on && a.find)) throw Bd("isecdom", b)
		}
		return a
	}
	...
	function ec(a, b, d, e, f) {
		...
		for (var g, h = 0; 1 < b.length; h++) {
			g = cc(b.shift(), e);
			var i = a[g];
			i || (i = {}, a[g] = i), a = i, a.then && f.unwrapPromises && (Ad(e), "$$v" in a || function(a) {
				a.then(function(b) {
					a.$$v = b
				})
			}(a), a.$$v === c && (a.$$v = {}), a = a.$$v)
		}
		return g = cc(b.shift(), e), a[g] = d
	}

	function fc(a, b, d, e, f, g, h) {
		return cc(a, g), cc(b, g), cc(d, g), cc(e, g), cc(f, g), h.unwrapPromises ? function(h, i) {
			var j, k = i && i.hasOwnProperty(a) ? i : h;
			return null == k ? k : ((k = k[a]) && k.then && (Ad(g), "$$v" in k || (j = k, j.$$v = c, j.then(function(a) {
				j.$$v = a
			})), k = k.$$v), null == k ? b ? c : k : ((k = k[b]) && k.then && (Ad(g), "$$v" in k || (j = k, j.$$v = c, j.then(function(a) {
				j.$$v = a
			})), k = k.$$v), null == k ? d ? c : k : ((k = k[d]) && k.then && (Ad(g), "$$v" in k || (j = k, j.$$v = c, j.then(function(a) {
				j.$$v = a
			})), k = k.$$v), null == k ? e ? c : k : ((k = k[e]) && k.then && (Ad(g), "$$v" in k || (j = k, j.$$v = c, j.then(function(a) {
				j.$$v = a
			})), k = k.$$v), null == k ? f ? c : k : ((k = k[f]) && k.then && (Ad(g), "$$v" in k || (j = k, j.$$v = c, j.then(function(a) {
				j.$$v = a
			})), k = k.$$v), k)))))
		} : function(g, h) {
	...
	function ic(a, b, d) {
		if (Hd.hasOwnProperty(a)) return Hd[a];
		var e, g = a.split("."),
			h = g.length;
		if (b.unwrapPromises || 1 !== h)
			if (b.unwrapPromises || 2 !== h)
				if (b.csp) e = 6 > h ? fc(g[0], g[1], g[2], g[3], g[4], d, b) : function(a, e) {
					var f, i = 0;
					do f = fc(g[i++], g[i++], g[i++], g[i++], g[i++], d, b)(a, e), e = c, a = f; while (h > i);
					return f
				};
				else {
					var i = "var p;\n";
					f(g, function(a, c) {
						cc(a, d), i += "if(s == null) return undefined;\ns=" + (c ? "s" : '((k&&k.hasOwnProperty("' + a + '"))?k:s)') + '["' + a + '"];\n' + (b.unwrapPromises ? 'if (s && s.then) {\n pw("' + d.replace(/(["\r\n])/g, "\\$1") + '");\n if (!("$$v" in s)) {\n p=s;\n p.$$v = undefined;\n p.then(function(v) {p.$$v=v;});\n}\n s=s.$$v\n}\n' : "")
					});
					var i = i + "return s;",
						j = new Function("s", "k", "pw", i);
					j.toString = q(i), e = b.unwrapPromises ? function(a, b) {
						return j(a, b, Ad)
					} : j
				} else e = hc(g[0], g[1], d);
				else e = gc(g[0], d);
		return "hasOwnProperty" !== a && (Hd[a] = e), e
	}
	...
	function jc() {
		...
		this.unwrapPromises = function(a) {
			...
			function(c, d, e) {
				return b.csp = d.csp, Ad = function(a) {
					b.logPromiseWarnings && !Cd.hasOwnProperty(a) && (Cd[a] = !0, e.warn("[$parse] Promise found in the expression `" + a + "`. Automatic unwrapping of promises in Angular expressions is deprecated."))
				},
				function(d) {
					var e;
					switch (typeof d) {
						case "string":
							return a.hasOwnProperty(d) ? a[d] : (e = new Fd(b), e = new Gd(e, c, b)
								.parse(d, !1), "hasOwnProperty" !== d && (a[d] = e), e);
						case "function":
							return d;
						default:
							return o
	...
	function mc() {
		...
		this.digestTtl = function(b) {
			...
			function(d, f, g, h) {
				...
				function k(a) {
					if (n.$$phase) throw b("inprog", n.$$phase);
					n.$$phase = a
				}
				...
				i.prototype = {
					...
					$watchCollection: function(a, b) {
						...
						return this.$watch(function() {
							...
							if (t(d))
								if (e(d))
									for (c !== j && (c = j, l = c.length = 0, h++), a = d.length, l !== a && (h++, c.length = l = a), b = 0; a > b; b++) c[b] !== d[b] && (h++, c[b] = d[b]);
								else {
									c !== k && (c = k = {}, l = 0, h++), a = 0;
									for (b in d) d.hasOwnProperty(b) && (a++, c.hasOwnProperty(b) ? c[b] !== d[b] && (h++, c[b] = d[b]) : (l++, c[b] = d[b], h++));
									if (l > a)
										for (b in h++, c) c.hasOwnProperty(b) && !d.hasOwnProperty(b) && (l--, delete c[b])
								} else c !== d && (c = d, h++);
							return h
						}, function() {
							b(d, c, f)
					...
					$digest: function() {
						var d, e, g, h, i, j, l, o, p, q, r = this.$$asyncQueue,
							s = this.$$postDigestQueue,
							t = a,
							u = [];
						k("$digest"), c = null;
						do {
							for (j = !1, l = this; r.length;) {
								try {
							...
							a: do {
								if (h = l.$$watchers)
									for (i = h.length; i--;) try {
										if (d = h[i])
											if ((e = d.get(l)) === (g = d.last) || (d.eq ? H(e, g) : "number" == typeof e && "number" == typeof g && isNaN(e) && isNaN(g))) {
												if (d === c) {
													j = !1;
													break a
												}
											} else j = !0, c = d, d.last = d.eq ? F(e) : e, d.fn(e, g === m ? e : g, l), 5 > t && (o = 4 - t, u[o] || (u[o] = []), p = y(d.exp) ? "fn: " + (d.exp.name || d.exp.toString()) : d.exp, p += "; newVal: " + L(e) + "; oldVal: " + L(g), u[o].push(p))
									} catch (w) {
										n.$$phase = null, f(w)
									}
							...
							if (j && !t--) throw n.$$phase = null, b("infdig", a, L(u))
						} while (j || r.length);
						for (n.$$phase = null; s.length;) try {
							s.shift()()
						} catch (x) {
							f(x)
						}
					...
					$evalAsync: function(a) {
						n.$$phase || n.$$asyncQueue.length || h.defer(function() {
					...
					$emit: function(a) {
						var b, c, d, e = [],
							...
							i = {
								...
								defaultPrevented: !1
							}, j = [i].concat(Uc.call(arguments, 1));
						do {
					...
					$broadcast: function(a) {
						var b, c, d = this,
							...
							g = {
								...
								defaultPrevented: !1
							}, h = [g].concat(Uc.call(arguments, 1));
						do {
							for (d = e, g.currentScope = d, e = d.$$listeners[a] || [], b = 0, c = e.length; c > b; b++)
								if (e[b]) try {
									e[b].apply(null, h)
								} catch (i) {
									f(i)
	...
	function nc() {
		...
		this.aHrefSanitizationWhitelist = function(b) {
			...
			return function(c, d) {
				var e, f = d ? b : a;
				return Nc && !(Nc >= 8) || (e = uc(c)
					.href, "" === e || e.match(f)) ? c : "unsafe:" + e
			}
		}
	}
	...
	function oc(a) {
		if ("self" === a) return a;
		if (u(a)) {
			if (-1 < a.indexOf("***")) throw Id("iwcard", a);
			return a = a.replace(/([-()\[\]{}+?*.$\^|,:#<!\\])/g, "\\$1")
				.replace(/\x08/g, "\\x08")
				.replace("\\*\\*", ".*")
				.replace("\\*", "[^:/.?&;]*"), RegExp("^" + a + "$")
	...
	function qc() {
		...
		this.resourceUrlWhitelist = function(b) {
			...
			function(d) {
				...
				var g = e(),
					h = {};
				return h[Jd.HTML] = e(g), h[Jd.CSS] = e(g), h[Jd.URL] = e(g), h[Jd.JS] = e(g), h[Jd.RESOURCE_URL] = e(h[Jd.URL]), {
					trustAs: function(a, b) {
						var d = h.hasOwnProperty(a) ? h[a] : null;
						if (!d) throw Id("icontext", a, b);
						if (null === b || b === c || "" === b) return b;
						if ("string" != typeof b) throw Id("itype", a);
						return new d(b)
					},
					getTrusted: function(d, e) {
						...
						if (d === Jd.RESOURCE_URL) {
							var i, j, g = uc(e.toString()),
								k = !1;
							for (i = 0, j = a.length; j > i; i++)
								if ("self" === a[i] ? vc(g) : a[i].exec(g.href)) {
									k = !0;
									break
								}
							if (k)
								for (i = 0, j = b.length; j > i; i++)
									if ("self" === b[i] ? vc(g) : b[i].exec(g.href)) {
										k = !1;
										break
									}
							if (k) return e;
							throw Id("insecurl", e.toString())
						}
						if (d === Jd.HTML) return f(e);
						throw Id("unsafe")
					},
					valueOf: function(a) {
	...
	function rc() {
		...
		this.enabled = function(b) {
			...
			function(b, c, d) {
				if (a && c.msie && 8 > c.msieDocumentMode) throw Id("iequirks");
				var e = F(Jd);
	...
	function sc() {
		this.$get = ["$window", "$document",
			function(a, b) {
				var c, d = {}, e = m((/android (\d+)/.exec(Sc((a.navigator || {})
						.userAgent)) || [])[1]),
					f = /Boxee/i.test((a.navigator || {})
						.userAgent),
					g = b[0] || {}, h = g.documentMode,
	...
	function uc(a) {
		var b = a;
		return Nc && (Kd.setAttribute("href", b), b = Kd.href), Kd.setAttribute("href", b), {
			href: Kd.href,
			protocol: Kd.protocol ? Kd.protocol.replace(/:$/, "") : "",
			host: Kd.host,
			search: Kd.search ? Kd.search.replace(/^\?/, "") : "",
			hash: Kd.hash ? Kd.hash.replace(/^#/, "") : "",
			hostname: Kd.hostname,
			port: Kd.port,
			pathname: "/" === Kd.pathname.charAt(0) ? Kd.pathname : "/" + Kd.pathname
		}
	}

	function vc(a) {
		return a = u(a) ? uc(a) : a, a.protocol === Ld.protocol && a.host === Ld.host
	}
	...
	function xc(a) {
		...
		], b("currency", zc), b("date", Fc), b("filter", yc), b("json", Gc), b("limitTo", Hc), b("lowercase", Qd), b("number", Ac), b("orderBy", Ic), b("uppercase", Rd)
	}
	...
	function zc(a) {
		...
		return function(a, c) {
			return r(c) && (c = b.CURRENCY_SYM), Bc(a, b.PATTERNS[1], b.GROUP_SEP, b.DECIMAL_SEP, 2)
				.replace(/\u00A4/g, c)
		}
	}
	...
	function Bc(a, b, c, d, e) {
		...
		if (j) e > 0 && a > -1 && 1 > a && (h = a.toFixed(e));
			...
			g = (g.split(Md)[1] || "")
				.length, r(e) && (e = Math.min(Math.max(b.minFrac, g), b.maxFrac)), g = Math.pow(10, e), a = Math.round(a * g) / g, a = ("" + a)
				.split(Md), g = a[0], a = a[1] || "";
			var k = 0,
				l = b.lgSize,
				m = b.gSize;
			if (g.length >= l + m)
				for (k = g.length - l, j = 0; k > j; j++) 0 === (k - j) % m && 0 !== j && (h += c), h += g.charAt(j);
	...
	function Fc(a) {
		...
		return function(c, d) {
			var e, g, h = "",
				i = [];
			if (d = d || "mediumDate", d = a.DATETIME_FORMATS[d] || d, u(c) && (c = Pd.test(c) ? m(c) : b(c)), v(c) && (c = new Date(c)), !w(c)) return c;
			for (; d;)(g = Od.exec(d)) ? (i = i.concat(Uc.call(g, 1)), d = i.pop()) : (i.push(d), d = null);
			return f(i, function(b) {
				e = Nd[b], h += e ? e(c, a.DATETIME_FORMATS) : b.replace(/(^'|'$)/g, "")
					.replace(/''/g, "'")
			}), h
		}
	}
	...
	function Ic(a) {
		return function(b, c, d) {
			...
			c = x(c) ? c : [c], c = C(c, function(b) {
				var c = !1,
					d = b || p;
				return u(b) && (("+" == b.charAt(0) || "-" == b.charAt(0)) && (c = "-" == b.charAt(0), b = b.substring(1)), d = a(b)), e(function(a, b) {
					var c;
					c = d(a);
					var e = d(b),
						f = typeof c,
						g = typeof e;
					return f == g ? ("string" == f && (c = c.toLowerCase(), e = e.toLowerCase()), c = c === e ? 0 : e > c ? -1 : 1) : c = g > f ? -1 : 1, c
				}, c)
			});
	...
	function Kc(a, b) {
		function c(b, c) {
			c = c ? "-" + W(c, "-") : "", a.removeClass((b ? ce : be) + c)
				.addClass((b ? be : ce) + c)
		}
		var d = this,
			e = a.parent()
			...
			g = 0,
			h = d.$error = {}, i = [];
		d.$name = b.name || b.ngForm, d.$dirty = !1, d.$pristine = !0, d.$valid = !0, d.$invalid = !1, e.$addControl(d), a.addClass(de), c(!0), d.$addControl = function(a) {
			...
			var i = h[a];
			if (b) i && (E(i, f), i.length || (g--, g || (c(b), d.$valid = !0, d.$invalid = !1), h[a] = !1, c(!0, a), e.$setValidity(a, !0, d)));
			else {
				if (g || c(b), i) {
					if (-1 != D(i, f)) return
			...
			a.removeClass(de)
				.addClass(ee), d.$dirty = !0, d.$pristine = !1, e.$setDirty()
		}, d.$setPristine = function() {
			a.removeClass(ee)
				.addClass(de), d.$dirty = !1, d.$pristine = !0, f(i, function(a) {
					a.$setPristine()
				})
		}
	}

	function Lc(a, b, e, f, g, h) {
		if (!g.android) {
			var i = !1;
		...
		var j = function() {
			if (!i) {
				var c = b.val();
				N(e.ngTrim || "T") && (c = $c(c)), f.$viewValue !== c && a.$apply(function() {
					f.$setViewValue(c)
				})
			}
		};
		...
		if (n && ((g = n.match(/^\/(.*)\/([gim]*)$/)) ? (n = RegExp(g[1], g[2]), g = function(a) {
			return o(n, a)
		}) : g = function(c) {
			var e = a.$eval(n);
			if (!e || !e.test) throw d("ngPattern")("noregexp", n, e, O(b));
			return o(e, c)
		}, f.$formatters.push(g), f.$parsers.push(g)), e.ngMinlength) {
			var p = m(e.ngMinlength);
			g = function(a) {
				return !f.$isEmpty(a) && a.length < p ? (f.$setValidity("minlength", !1), c) : (f.$setValidity("minlength", !0), a)
			}, f.$parsers.push(g), f.$formatters.push(g)
		}
		if (e.ngMaxlength) {
			var q = m(e.ngMaxlength);
			g = function(a) {
				return !f.$isEmpty(a) && a.length > q ? (f.$setValidity("maxlength", !1), c) : (f.$setValidity("maxlength", !0), a)
			}, f.$parsers.push(g), f.$formatters.push(g)
		}
	}
	...
	var Nc, Oc, Pc, Qc, Rc, Sc = function(a) {
		...
		Xc = d("ng"),
		Yc = a.angular || (a.angular = {}),
		Zc = ["0", "0", "0"];
	Nc = m((/msie (\d+)/.exec(Sc(navigator.userAgent)) || [])[1]), isNaN(Nc) && (Nc = m((/trident\/.*; rv:(\d+)/.exec(Sc(navigator.userAgent)) || [])[1])), o.$inject = [], p.$inject = [];
	var $c = function() {
		return String.prototype.trim ? function(a) {
			return u(a) ? a.trim() : a
		} : function(a) {
			return u(a) ? a.replace(/^\s\s*/, "")
				.replace(/\s\s*$/, "") : a
		}
	}();
	Rc = 9 > Nc ? function(a) {
		return a = a.nodeName ? a : a[0], a.scopeName && "HTML" != a.scopeName ? Tc(a.scopeName + ":" + a.nodeName) : a.nodeName
	} : function(a) {
	...
	var _c = /[A-Z]/g,
		...
		}, bd = db.cache = {}, cd = db.expando = "ng-" + (new Date)
			.getTime(),
		dd = 1,
		ed = a.document.addEventListener ? function(a, b, c) {
			a.addEventListener(b, c, !1)
	} : function(a, b, c) {
		a.attachEvent("on" + b, c)
	}, fd = a.document.removeEventListener ? function(a, b, c) {
		...
		jd = db.prototype = {
			ready: function(c) {
				...
				var e = !1;
				"complete" === b.readyState ? setTimeout(d) : (this.on("DOMContentLoaded", d), db(a)
					.on("load", d))
			},
			toString: function() {
				var a = [];
			...
			eq: function(a) {
				return Oc(a >= 0 ? this[a] : this[this.length + a])
			},
			length: 0,
			push: Vc,
			sort: [].sort,
	...
	f("input select option textarea button form details".split(" "), function(a) {
		...
		scope: function(a) {
			return Oc(a)
				.data("$scope") || pb(a.parentNode || a, ["$isolateScope", "$scope"])
		},
		isolateScope: function(a) {
			return Oc(a)
				.data("$isolateScope") || Oc(a)
		...
		css: function(a, b, d) {
			if (b = bb(b), !s(d)) {
				var e;
				return 8 >= Nc && (e = a.currentStyle && a.currentStyle[b], "" === e && (e = "auto")), e = e || a.style[b], 8 >= Nc && (e = "" === e ? c : e), e
			}
			a.style[b] = d
		},
		attr: function(a, b, d) {
			var e = Sc(b);
			if (kd[e]) {
				if (!s(d)) return a[b] || (a.attributes.getNamedItem(b) || o)
					.specified ? e : c;
		...
		text: function() {
			...
			var b = [];
			return 9 > Nc ? (b[1] = "innerText", b[3] = "nodeValue") : b[1] = b[3] = "textContent", a.$dv = "", a
		}(),
		val: function(a, b) {
			if (r(b)) {
		...
		removeData: hb,
		dealoc: fb,
		on: function Pe(a, c, d, e) {
			if (s(e)) throw id("onargs");
			var g = ib(a, "events"),
				h = ib(a, "handle");
		...
		db.prototype[b] = function(b, c, d) {
			for (var e, f = 0; f < this.length; f++) r(e) ? (e = a(this[f], b, c, d), s(e) && (e = Oc(e))) : nb(e, a(this[f], b, c, d));
			return s(e) ? e : this
		...
		sd = ["$provide",
			function(a) {
				this.$$selectors = {}, this.register = function(b, c) {
					var d = b + "-animation";
					if (b && "." != b.charAt(0)) throw rd("notcsel", b);
	...
	Zb.prototype = Yb.prototype = Xb.prototype = {
		$$html5: !1,
		$$replace: !1,
		absUrl: $b("$$absUrl"),
		url: function(a, b) {
		...
		search: function(a, b) {
			switch (arguments.length) {
				case 0:
					return this.$$search;
				case 1:
					if (u(a)) this.$$search = Q(a);
					else {
						if (!t(a)) throw zd("isrcharg");
						this.$$search = a
					}
					break;
				default:
	...
	Fd.prototype = {
		...
		lex: function(a) {
			...
			for (a = []; this.index < this.text.length;) {
				...
				else if (this.isIdent(this.ch)) this.readIdent(), this.was("{,") && "{" === a[0] && (b = this.tokens[this.tokens.length - 1]) && (b.json = -1 === b.text.indexOf("."));
		...
		throwError: function(a, b, c) {
			throw c = c || this.index, b = s(b) ? "s " + b + "-" + this.index + " [" + this.text.substring(b, c) + "]" : " " + c, Bd("lexerr", a, b, this.text)
		},
		readNumber: function() {
			for (var a = "", b = this.index; this.index < this.text.length;) {
				var c = Sc(this.text.charAt(this.index));
		...
		readIdent: function() {
			...
			if (g = {
				index: g,
				text: f
			}, Dd.hasOwnProperty(f)) g.fn = Dd[f], g.json = Dd[f];
			else {
				var h = ic(f, this.options, this.text);
				g.fn = l(function(a, b) {
					return h(a, b)
				}, {
					assign: function(a, b) {
						return ec(a, f, b, e.text, e.options)
					}
				})
			}
		...
		readString: function(a) {
			...
			for (var c = "", d = a, e = !1; this.index < this.text.length;) {
				var f = this.text.charAt(this.index),
					d = d + f;
				if (e) "u" === f ? (f = this.text.substring(this.index + 1, this.index + 5), f.match(/[\da-f]{4}/i) || this.throwError("Invalid unicode escape [\\u" + f + "]"), this.index += 4, c += String.fromCharCode(parseInt(f, 16))) : c = (e = Ed[f]) ? c + e : c + f, e = !1;
				else if ("\\" === f) e = !0;
				else {
	...
	Gd.ZERO = function() {
		...
		primary: function() {
			...
			if (this.expect("(")) a = this.filterChain(), this.consume(")");
				...
				var b = this.expect();
				(a = b.fn) || this.throwError("not a primary expression", b), b.json && (a.constant = !0, a.literal = !0)
			}
		...
		throwError: function(a, b) {
			throw Bd("syntax", b.text, a, b.index + 1, this.text, this.text.substring(b.index))
		},
		peekToken: function() {
			if (0 === this.tokens.length) throw Bd("ueoe", this.text);
		...
		expect: function(a, b, c, d) {
			return (a = this.peek(a, b, c, d)) ? (this.json && !a.json && this.throwError("is not valid json", a), this.tokens.shift(), a) : !1
		},
		consume: function(a) {
		...
		unary: function() {
			var a;
			return this.expect("+") ? this.primary() : (a = this.expect("-")) ? this.binaryFn(Gd.ZERO, a.fn, this.unary()) : (a = this.expect("!")) ? this.unaryFn(a.fn, this.unary()) : this.primary()
		},
		fieldAccess: function(a) {
			var b = this,
				c = this.expect()
					.text,
				d = ic(c, this.options, this.text);
			return l(function(b, c, e) {
				return d(e || a(b, c), c)
			}, {
				assign: function(d, e, f) {
					return ec(a(d, f), c, e, b.text, b.options)
				}
			})
		},
		objectIndex: function(a) {
			...
			return this.consume("]"), l(function(e, f) {
				var g, h = a(e, f),
					i = d(e, f);
				return h ? ((h = dc(h[i], b.text)) && h.then && b.options.unwrapPromises && (g = h, "$$v" in h || (g.$$v = c, g.then(function(a) {
					g.$$v = a
				})), h = h.$$v), h) : c
			}, {
				assign: function(c, e, f) {
					var g = d(c, f);
					return dc(a(c, f), b.text)[g] = e
				}
			})
		},
		functionCall: function(a, b) {
			...
			return function(e, f) {
				...
				return i = a(e, f, h) || o, dc(h, d.text), dc(i, d.text), g = i.apply ? i.apply(h, g) : i(g[0], g[1], g[2], g[3], g[4]), dc(g, d.text)
			}
		},
	...
	var Hd = {}, Id = d("$sce"),
		Jd = {
			...
			JS: "js"
		}, Kd = b.createElement("a"),
		Ld = uc(a.location.href, !0);
	...
	var Sd = q({
		...
		compile: function(a, c) {
			return 8 >= Nc && (c.href || c.name || c.$set("href", ""), a.append(b.createComment("IE fix"))), c.href || c.name ? void 0 : function(a, b) {
	...
	var Vd = function(a) {
					...
					return {
						pre: function(a, d, e, f) {
							if (!e.action) {
								...
								ed(d[0], "submit", g), d.on("$destroy", function() {
									b(function() {
										fd(d[0], "submit", g)
									}, 0, !1)
								})
							...
							var h = d.parent()
								.controller("form"),
								i = e.name || e.ngForm;
							i && ec(a, i, f, i), h && d.on("$destroy", function() {
								h.$removeControl(f), i && ec(a, i, c, i), l(f, Ud)
							})
						}
					}
				}
		...
		_d = {
			...
			number: function(a, b, d, e, f, g) {
				Lc(a, b, d, e, f, g), e.$parsers.push(function(a) {
					var b = e.$isEmpty(a);
					return b || $d.test(a) ? (e.$setValidity("number", !0), "" === a ? null : b ? a : parseFloat(a)) : (e.$setValidity("number", !1), c)
			...
			url: function(a, b, d, e, f, g) {
				Lc(a, b, d, e, f, g), a = function(a) {
					return e.$isEmpty(a) || Yd.test(a) ? (e.$setValidity("url", !0), a) : (e.$setValidity("url", !1), c)
				}, e.$formatters.push(a), e.$parsers.push(a)
			},
			email: function(a, b, d, e, f, g) {
				Lc(a, b, d, e, f, g), a = function(a) {
					return e.$isEmpty(a) || Zd.test(a) ? (e.$setValidity("email", !0), a) : (e.$setValidity("email", !1), c)
				}, e.$formatters.push(a), e.$parsers.push(a)
			},
			...
			function(a, b) {
				return {
					...
					link: function(c, d, e, f) {
						f && (_d[Sc(e.type)] || _d.text)(c, d, e, f, b, a)
					}
				}
			}
		],
		...
		de = "ng-pristine",
		ee = "ng-dirty",
		fe = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse",
			function(a, b, c, e, g) {
				function h(a, b) {
					b = b ? "-" + W(b, "-") : "", e.removeClass((a ? ce : be) + b)
						.addClass((a ? be : ce) + b)
				}
				...
				var k = e.inheritedData("$formController") || Ud,
					l = 0,
					m = this.$error = {};
				e.addClass(de), h(!0), this.$setValidity = function(a, b) {
					...
					this.$dirty = !1, this.$pristine = !0, e.removeClass(ee)
						.addClass(de)
				}, this.$setViewValue = function(c) {
					this.$viewValue = c, this.$pristine && (this.$dirty = !0, this.$pristine = !1, e.removeClass(de)
						.addClass(ee), k.$setDirty()), f(this.$parsers, function(a) {
						c = a(c)
		...
		}, me = Jc(function(a, b, d) {
			b.addClass("ng-binding")
				.data("$binding", d.ngBind), a.$watch(d.ngBind, function(a) {
					b.text(a == c ? "" : a)
				})
		}),
		ne = ["$interpolate",
			function(a) {
				return function(b, c, d) {
					b = a(c.attr(d.$attr.ngBindTemplate)), c.addClass("ng-binding")
						.data("$binding", b), d.$observe("ngBindTemplate", function(a) {
							c.text(a)
						})
				}
			}
				...
				return {
					...
					link: function(d, e, g) {
						var h = g.count,
							...
							o = /^when(Minus)?(.+)$/;
						f(g, function(a, b) {
							o.test(b) && (k[Sc(b.replace("when", "")
								.replace("Minus", "-"))] = e.attr(g.$attr[b]))
						}), f(k, function(a, d) {
			...
			function(a, c) {
				...
				return {
					...
					link: function(d, h, i, j, k) {
						...
						if (!s) throw g("iexp", r);
						if (i = s[1], j = s[2], (s = s[4]) ? (l = a(s), m = function(a, b, c) {
						...
						d.$watchCollection(j, function(a) {
							...
							for (s = x.length, j = B.length = x.length, i = 0; j > i; i++)
								if (v = a === x ? i : x[i], w = a[v], w = l(v, w, i), Z(w, "`track by` id"), u.hasOwnProperty(w)) y = u[w], delete u[w], A[w] = y, B[i] = y;
								else {
							...
							for (i = 0, j = x.length; j > i; i++) {
								if (v = a === x ? i : x[i], w = a[v], y = B[i], B[i - 1] && (z = B[i - 1].clone[B[i - 1].clone.length - 1]), y.scope) {
									t = y.scope, l = z;
									do l = l.nextSibling; while (l && l.$$NG_REMOVED);
									y.clone[0] != l && c.move(_(y.clone), null, Oc(z)), z = y.clone[y.clone.length - 1]
								} else t = d.$new();
								t[p] = w, q && (t[q] = v), t.$index = i, t.$first = 0 === i, t.$last = i === s - 1, t.$middle = !(t.$first || t.$last), t.$odd = !(t.$even = 0 === (1 & i)), y.scope || k(t, function(a) {
									a[a.length++] = b.createComment(" end ngRepeat: " + r + " "), c.enter(a, null, Oc(z)), z = a, y.scope = t, y.clone = a, A[y.id] = y
								})
							}
							u = A
						})
					...
					link: function(h, i, j, k) {
						...
						function n(b, f, h) {
							function i() {
								...
								if (q)
									if (r && x(e))
										for (d = new ub([]), B = 0; B < e.length; B++) A[l] = e[B], d.put(r(b, A), e[B]);
									else d = new ub(e);
								for (B = 0; z = C.length, z > B; B++) {
									...
									A[l] = i[c], a = n(b, A) || "", (c = j[a]) || (c = j[a] = [], t.push(a)), q ? a = s(d.remove(r ? r(b, A) : o(b, A))) : (r ? (a = {}, a[l] = e, a = r(b, a) === r(b, A)) : a = e === o(b, A), d = d || a), D = k(b, A), D = s(D) ? D : "", c.push({
										id: r ? r(b, A) : m ? C[B] : B,
										label: D,
										selected: a
									})
								...
								for (q || (u || null === e ? j[""].unshift({
									...
									for (a = t[A], c = j[a], y.length <= A ? (e = {
										element: w.clone()
											.attr("label", a),
										label: c.label
									}, i = [e], y.push(i), f.append(e.element)) : (i = y[A], e = i[0], e.label != a && e.element.attr("label", e.label = a)), D = null, B = 0, z = c.length; z > B; B++) d = c[B], (a = i[B + 1]) ? (D = a.element, a.label !== d.label && D.text(a.label = d.label), a.id !== d.id && D.val(a.id = d.id), D[0].selected !== d.selected && D.prop("selected", a.selected = d.selected)) : ("" === d.id && u ? E = u : (E = v.clone())
										.val(d.id)
									...
									for (B++; i.length > B;) i.pop()
										.element.remove()
								}
								for (; y.length > A;) y.pop()[0].element.remove()
							}
							var j;
							if (!(j = t.match(e))) throw Ke("iexp", t, O(f));
							var k = d(j[2] || j[1]),
								l = j[4] || j[6],
								m = j[5],
								n = d(j[3] || ""),
							...
							u && (a(u)(b), u.removeClass("ng-scope"), u.remove()), f.empty(), f.on("change", function() {
								b.$apply(function() {
									var a, d, e, g, i, j, k, n, s = p(b) || [],
										t = {};
									if (q) {
										for (e = [], i = 0, k = y.length; k > i; i++)
											for (a = y[i], g = 1, j = a.length; j > g; g++)
												if ((d = a[g].element)[0].selected) {
													if (d = d.val(), m && (t[m] = d), r)
														for (n = 0; n < s.length && (t[l] = s[n], r(b, t) != d); n++);
													else t[l] = s[d];
													e.push(o(b, t))
												}
						...
						if (k[1]) {
							...
							var p, q = j.multiple,
								t = j.ngOptions,
								u = !1,
								v = Oc(b.createElement("option")),
								w = Oc(b.createElement("optgroup")),
								y = v.clone();
							j = 0;
							for (var z = i.children(), A = z.length; A > j; j++)
								if ("" === z[j].value) {
									p = u = z.eq(j);
									break
								}
				...
				return {
					...
					compile: function(c, d) {
						...
						return function(a, c, d) {
							var f = c.parent(),
								g = f.data("$selectController") || f.parent()
...
}(window, document), !angular.$$csp() && angular.element(document)
	.find("head")
...
better_resource_module.factory("btrResource", ["$resource", "$rootScope",
	function(a, b) {
		function c(c, d, e) {
			function f(a) {
				console.log("setting up watch"), a.unsaved = !1, b.$watch(function() {
					return a
				}, function(b, c) {
					if (!angular.equals(b, c)) {
						var d = [];
						for (var e in b) angular.equals(b[e], c[e]) || d.push(e);
						var f = ["unsaved", "$$hashKey"],
							g = 0;
						for (var e in f)
							for (var h in d) d[h] == f[e] && g++;
						null != b && null != c && d.length != g && (console.log("detected change. setting unsaved to true", d), a.unsaved = !0)
					}
				}, !0)
			}
			...
			var h = a(c, d, e);
			return h.orig_get = h.get, h.orig_query = h.query, h.query = function(a, b) {
				var c = h.orig_query(a, function(a) {
					for (var c in a) f(a[c]);
					void 0 != b && b()
				});
				return c
			}, h.get = function(a, b) {
				var c = h.orig_get(a, function() {
					f(c), void 0 != b && b()
				});
				return c
			}, h.prototype.orig_save = h.prototype.$save, h.prototype.$save = function(a) {
				if (this.unsaved) var b = this.orig_save(function() {
					this.unsaved = !1, g(a)
				});
				else {
					var b = this;
	...
	"undefined" != typeof module && module.exports ? module.exports = c() : "function" == typeof b.define && b.define.amd ? define(a, [], c) : b[a] = c()
})("buzz", this, function() {
	var a = {
		defaults: {
			autoplay: !1,
		...
		sound: function(b, c) {
			...
			if (this.load = function() {
				...
				for (var l in a.defaults) a.defaults.hasOwnProperty(l) && (c[l] = c[l] || a.defaults[l]);
				if (this.sound = g.createElement("audio"), b instanceof Array)
	...
	function i(a) {
		return a = mh + a, a in this && delete this[a]
	}
	...
	function k() {
		var a = 0;
		for (var b in this) b.charCodeAt(0) === nh && ++a;
		return a
	}

	function l() {
		for (var a in this)
			if (a.charCodeAt(0) === nh) return !1;
		return !0
	}
	...
	function r(a) {
		...
		return b.on = function(b, e) {
			var f, g = d.get(b);
			return arguments.length < 2 ? g && g.on : (g && (g.on = null, c = c.slice(0, f = c.indexOf(g))
				.concat(c.slice(f + 1)), d.remove(b)), e && c.push(d.set(b, {
				on: e
			})), a)
		}, b
	}
	...
	function s() {
		Zg.event.preventDefault()
	}

	function t() {
		for (var a, b = Zg.event; a = b.sourceEvent;) b = a;
		return b
	}
	...
	function u(a) {
		...
		return b.of = function(c, d) {
			return function(e) {
				try {
					var f = e.sourceEvent = Zg.event;
					e.target = a, Zg.event = e, b[e.type].apply(c, d)
				} finally {
					Zg.event = f
				}
			}
	...
	function y(a, b) {
		...
		return a = Zg.ns.qualify(a), null == b ? a.local ? d : c : "function" == typeof b ? a.local ? h : g : a.local ? f : e
	}
	...
	function A(a) {
		return new RegExp("(?:^|\\s+)" + Zg.requote(a) + "(?:\\s+|$)", "g")
	}
	...
	function G(a) {
		return "function" == typeof a ? a : (a = Zg.ns.qualify(a))
			.local ? function() {
	...
	function O(a, b, c) {
		...
		function e() {
			var e = i(b, _g(arguments));
			d.call(this), this.addEventListener(a, this[g] = e, e.$ = c), e._ = b
		}

		function f() {
			var b, c = new RegExp("^__on([^.]+)" + Zg.requote(a) + "$");
			for (var d in this)
				if (b = d.match(c)) {
					var e = this[d];
	...
	function R() {
		...
		return function(f) {
			...
			c.on(a, null), Ah && (d[Ah] = e), f && (c.on(b, function() {
				s(), g()
			}, !0), setTimeout(g, 0))
		}
	}
	...
	function S(a, b) {
		...
		if (c.createSVGPoint) {
			...
			return d.x = b.clientX, d.y = b.clientY, d = d.matrixTransform(a.getScreenCTM()
				.inverse()), [d.x, d.y]
		}
	...
	function T() {
		return Zg.event.changedTouches[0].identifier
	}

	function U() {
		return Zg.event.target
	}
	...
	function Y(a) {
		return a > 1 ? 0 : -1 > a ? Ch : Math.acos(a)
	}

	function Z(a) {
		return a > 1 ? Eh : -1 > a ? -Eh : Math.asin(a)
	}
	...
	function ib(a, b, c) {
		return isNaN(a) && (a = 0), isNaN(b) && (b = 0), jb(c, Math.cos(a *= Hh) * b, Math.sin(a) * b)
	}
	...
	function lb(a, b, c) {
		var d = (a + 16) / 116,
			e = d + b / 500,
			f = d - c / 200;
		return e = nb(e) * Sh, d = nb(d) * Th, f = nb(f) * Uh, sb(pb(3.2404542 * e - 1.5371385 * d - .4985314 * f), pb(-.969266 * e + 1.8760108 * d + .041556 * f), pb(.0556434 * e - .2040259 * d + 1.0572252 * f))
	}

	function mb(a, b, c) {
		return a > 0 ? gb(Math.atan2(c, b) * Ih, Math.sqrt(b * b + c * c), a) : gb(0 / 0, 0 / 0, a)
	}
	...
	function ub(a) {
		return 16 > a ? "0" + Math.max(0, a)
			.toString(16) : Math.min(255, a)
			.toString(16)
	}
	...
	function vb(a, b, c) {
		...
		return (f = Xh.get(a)) ? b(f.r, f.g, f.b) : (null == a || "#" !== a.charAt(0) || isNaN(f = parseInt(a.substring(1), 16)) || (4 === a.length ? (g = (3840 & f) >> 4, g = g >> 4 | g, h = 240 & f, h = h >> 4 | h, i = 15 & f, i = i << 4 | i) : 7 === a.length && (g = (16711680 & f) >> 16, h = (65280 & f) >> 8, i = 255 & f)), b(g, h, i))
	}
	...
	function xb(a, b, c) {
		...
		var d = ob((.4124564 * a + .3575761 * b + .1804375 * c) / Sh),
			e = ob((.2126729 * a + .7151522 * b + .072175 * c) / Th),
			f = ob((.0193339 * a + .119192 * b + .9503041 * c) / Uh);
	...
	function Db(a, b, c, d) {
		...
		var f = {}, g = Zg.dispatch("beforesend", "progress", "load", "error"),
			h = {}, i = new XMLHttpRequest,
			j = null;
		return !ch.XDomainRequest || "withCredentials" in i || !/^(http(s)?:)?\/\//.test(a) || (i = new XDomainRequest), "onload" in i ? i.onload = i.onerror = e : i.onreadystatechange = function() {
			i.readyState > 3 && e()
			...
			return a = (a + "")
				.toLowerCase(), arguments.length < 2 ? h[a] : (null == b ? delete h[a] : h[a] = b + "", f)
			...
			f[a] = function() {
				return f.send.apply(f, [a].concat(_g(arguments)))
			}
			...
			return null != b && i.overrideMimeType && i.overrideMimeType(b), null != j && (i.responseType = j), null != e && f.on("error", e)
				.on("load", function(a) {
					e(null, a)
				}), g.beforesend.call(f, i), i.send(null == d ? null : d), f
		}, f.abort = function() {
			return i.abort(), f
		}, Zg.rebind(f, g, "on"), null == d ? f : f.get(Eb(d))
	}
	...
	function Fb() {
		var a = Gb(),
			b = Hb() - a;
		b > 24 ? (isFinite(b) && (clearTimeout(_h), _h = setTimeout(Fb, b)), $h = 0) : ($h = 1, bi(Fb))
	}

	function Gb() {
		var a = Date.now();
		for (ai = Yh; ai;) a >= ai.t && (ai.f = ai.c(a - ai.t)), ai = ai.n;
		return a
	}

	function Hb() {
		for (var a, b = Yh, c = 1 / 0; b;) b.f ? b = a ? a.n = b.n : Yh = b.n : (b.t < c && (c = b.t), b = (a = b)
			.n);
		return Zh = a, c
	}
	...
	function Kb(a) {
		...
		return function(a) {
			...
			"$" === i && (p = e[0], q = e[1]), "r" != n || m || (n = "g"), null != m && ("g" == n ? m = Math.max(1, Math.min(21, m)) : ("e" == n || "f" == n) && (m = Math.max(0, Math.min(20, m)))), n = ei.get(n) || Lb;
			var s = j && l;
			return function(a) {
				var c = q;
				if (r && a % 1) return "";
	...
	function Nb(a, b, c) {
		...
		function e(c) {
			return b(c = a(new gi(c - 1)), 1), c
		}

		function f(a, c) {
			return b(a = new gi(+a), c), a
		}
	...
	function Pb(a) {
		function b(a) {
			function b(b) {
				for (var c, e, f, g = [], h = -1, i = 0; ++h < d;) 37 === a.charCodeAt(h) && (g.push(a.substring(i, h)), null != (e = ii[c = a.charAt(++h)]) && (c = a.charAt(++h)), (f = C[c]) && (c = f(b, null == e ? "e" === c ? " " : "0" : e)), g.push(c), i = h + 1);
		...
		function c(a, b, c, d) {
			for (var e, f, g, h = 0, i = b.length, j = c.length; i > h;) {
				...
				if (e = b.charCodeAt(h++), 37 === e) {
					if (g = b.charAt(h++), f = D[g in ii ? b.charAt(h++) : g], !f || (d = f(a, c, d)) < 0) return -1
		...
		var C = {
			...
			j: function(a, b) {
				return Qb(1 + fi.dayOfYear(a), b, 3)
			},
			L: function(a, b) {
			...
			U: function(a, b) {
				return Qb(fi.sundayOfYear(a), b, 2)
			},
			w: function(a) {
				return a.getDay()
			},
			W: function(a, b) {
				return Qb(fi.mondayOfYear(a), b, 2)
			},
			x: b(m),
			X: b(n),
			y: function(a, b) {
	...
	function Qb(a, b, c) {
		var d = 0 > a ? "-" : "",
			e = (d ? -a : a) + "",
			f = e.length;
		return d + (c > f ? new Array(c - f + 1)
			.join(b) + e : e)
	}

	function Rb(a) {
		return new RegExp("^(?:" + a.map(Zg.requote)
			.join("|") + ")", "i")
	}
	...
	function Tb(a, b, c) {
		ji.lastIndex = 0;
		var d = ji.exec(b.substring(c, c + 1));
		return d ? (a.w = +d[0], c + d[0].length) : -1
	}

	function Ub(a, b, c) {
		ji.lastIndex = 0;
		var d = ji.exec(b.substring(c));
	...
	function Wb(a, b, c) {
		ji.lastIndex = 0;
		var d = ji.exec(b.substring(c, c + 4));
		return d ? (a.y = +d[0], c + d[0].length) : -1
	}

	function Xb(a, b, c) {
		ji.lastIndex = 0;
		var d = ji.exec(b.substring(c, c + 2));
	...
	function ac(a, b, c) {
		ji.lastIndex = 0;
		var d = ji.exec(b.substring(c, c + 3));
	...
	function kc(a, b) {
		a && oi.hasOwnProperty(a.type) && oi[a.type](a, b)
	}
	...
	function nc() {
		function a(a, b) {
			...
			var c = a - d,
				...
				l = e * i + k * Math.cos(h),
				m = k * g * Math.sin(h);
			qi.add(Math.atan2(m, l)), d = a, e = i, f = j
		}
		var b, c, d, e, f;
		ri.point = function(g, h) {
			ri.point = a, d = (b = g) * Hh, e = Math.cos(h = (c = h) * Hh / 2 + Ch / 4), f = Math.sin(h)
		}, ri.lineEnd = function() {
			a(b, c)
		}
	}
	...
	function vc(a, b) {
		return lh(a[0] - b[0]) < Fh && lh(a[1] - b[1]) < Fh
	}
	...
	function xc(a, b, c) {
		++si, ui += (a - ui) / si, vi += (b - vi) / si, wi += (c - wi) / si
	}
	...
	function yc() {
		function a(a, e) {
			...
			ti += j, xi += j * (b + (b = g)), yi += j * (c + (c = h)), zi += j * (d + (d = i)), xc(b, c, d)
		}
		var b, c, d;
		Di.point = function(e, f) {
			e *= Hh;
			var g = Math.cos(f *= Hh);
			b = g * Math.cos(e), c = g * Math.sin(e), d = Math.sin(f), Di.point = a, xc(b, c, d)
		}
	}
	...
	function Ac() {
		function a(a, b) {
			...
			var c = Math.cos(b *= Hh),
				...
				o = m && -Y(n) / m,
				p = Math.atan2(m, n);
			Ai += o * j, Bi += o * k, Ci += o * l, ti += p, xi += p * (d + (d = g)), yi += p * (e + (e = h)), zi += p * (f + (f = i)), xc(d, e, f)
		}
		var b, c, d, e, f;
		Di.point = function(g, h) {
			b = g, c = h, Di.point = a, g *= Hh;
			var i = Math.cos(h *= Hh);
			d = i * Math.cos(g), e = i * Math.sin(g), f = Math.sin(h), xc(d, e, f)
		}, Di.lineEnd = function() {
			a(b, c), Di.lineEnd = zc, Di.point = wc
		}
	}
		...
		return function(e, f) {
			...
			function m() {
				...
				if (p.pop(), o.push(p), p = null, d)
					...
					} else d > 1 && 2 & b && c.push(c.pop()
						.concat(c.shift())), n.push(c.filter(Gc))
			}
			var n, o, p, q = b(f),
				r = e.invert(d[0], d[1]),
				s = {
					...
					polygonEnd: function() {
						s.point = g, s.lineStart = i, s.lineEnd = j, n = Zg.merge(n);
						var a = Jc(r, o);
	...
	function Ic(a, b) {
		return ((a = a.x)[0] < 0 ? a[1] - Eh - Fh : Eh - a[1]) - ((b = b.x)[0] < 0 ? b[1] - Eh - Fh : Eh - b[1])
	}
	...
	function Jc(a, b) {
		...
		for (var h = 0, i = b.length; i > h; ++h) {
			var j = b[h],
				k = j.length;
			if (k)
				for (var l = j[0], m = l[0], n = l[1] / 2 + Ch / 4, o = Math.sin(n), p = Math.cos(n), q = 1;;) {
					q === k && (q = 0), a = j[q];
					var r = a[0],
						s = a[1] / 2 + Ch / 4,
						t = Math.sin(s),
						...
						y = x > Ch,
						z = o * t;
					if (qi.add(Math.atan2(z * w * Math.sin(x), p * u + z * Math.cos(x))), f += y ? v + w * Dh : v, y ^ m >= c ^ r >= c) {
						var A = qc(oc(l), oc(a));
						tc(A);
						var B = qc(e, A);
						tc(B);
	...
	function Kc(a) {
		...
		return {
			...
			point: function(f, g) {
				var h = f > 0 ? Ch : -Ch,
					i = lh(f - c);
				lh(i - Ch) < Fh ? (a.point(c, d = (d + g) / 2 > 0 ? Eh : -Eh), a.point(e, d), a.lineEnd(), a.lineStart(), a.point(h, d), a.point(f, d), b = 0) : e !== h && i >= Ch && (lh(c - e) < Fh && (c -= e * Fh), lh(f - h) < Fh && (f -= h * Fh), d = Lc(c, d, f, g), a.point(e, d), a.lineEnd(), a.lineStart(), a.point(h, d), b = 0), a.point(c = f, d = g), e = h
			},
			lineEnd: function() {
				a.lineEnd(), c = d = 0 / 0
			},
	...
	function Lc(a, b, c, d) {
		...
		return lh(g) > Fh ? Math.atan((Math.sin(b) * (f = Math.cos(d)) * Math.sin(c) - Math.sin(d) * (e = Math.cos(b)) * Math.sin(a)) / (e * f * g)) : (b + d) / 2
	}

	function Mc(a, b, c, d) {
		var e;
		if (null == a) e = c * Eh, d.point(-Ch, e), d.point(0, e), d.point(Ch, e), d.point(Ch, 0), d.point(Ch, -e), d.point(0, -e), d.point(-Ch, -e), d.point(-Ch, 0), d.point(-Ch, e);
		else if (lh(a[0] - b[0]) > Fh) {
			var f = a[0] < b[0] ? Ch : -Ch;
		...
		function c(a) {
			...
			return {
				...
				point: function(l, m) {
					var n, o = [l, m],
						p = b(l, m),
						q = g ? p ? 0 : e(l, m) : p ? e(l + (0 > l ? Ch : -Ch), m) : 0;
					if (!c && (j = i = p) && a.lineStart(), p !== i && (n = d(c, o), (vc(c, n) || vc(o, n)) && (o[0] += Fh, o[1] += Fh, p = b(o[0], o[1]))), p !== i) k = 0, p ? (a.lineStart(), n = d(o, c), a.point(n[0], n[1])) : (n = d(c, o), a.point(n[0], n[1]), a.lineEnd()), c = n;
					else if (h && c && g ^ p) {
						var r;
		...
		function d(a, b, c) {
			...
			if (!(0 > t)) {
				...
				var B = y - x,
					C = lh(B - Ch) < Fh,
					D = C || Fh > B;
				if (!C && z > A && (w = z, z = A, A = w), D ? C ? z + A > 0 ^ v[1] < (lh(v[0] - x) < Fh ? z : A) : z <= v[1] && v[1] <= A : B > Ch ^ (x <= v[0] && v[0] <= y)) {
					var E = sc(q, (-r + u) / s);
	...
	function Pc(a, b, c, d) {
		function e(d, e) {
			return lh(d[0] - a) < Fh ? e > 0 ? 0 : 3 : lh(d[0] - c) < Fh ? e > 0 ? 2 : 1 : lh(d[1] - b) < Fh ? e > 0 ? 1 : 0 : e > 0 ? 3 : 2
		}
		...
		return function(h) {
			...
			function o(a, b) {
				a = Math.max(-Fi, Math.min(Fi, a)), b = Math.max(-Fi, Math.min(Fi, b));
				var c = k(a, b);
	...
	function Rc(a) {
		...
		return e.parallels = function(a) {
			return arguments.length ? d(b = a[0] * Ch / 180, c = a[1] * Ch / 180) : [180 * (b / Ch), 180 * (c / Ch)]
		}, e
	}
	...
	function Tc() {
		...
		var b, c, d, e;
		Mi.point = function(f, g) {
			Mi.point = a, b = d = f, c = e = g
		}, Mi.lineEnd = function() {
			a(b, c)
		}
	}
	...
	function Uc(a, b) {
		Ii > a && (Ii = a), a > Ki && (Ki = a), Ji > b && (Ji = b), b > Li && (Li = b)
	}
	...
	function Yc() {
		function a(a, d) {
			var e = a - b,
				f = d - c,
				g = Math.sqrt(e * e + f * f);
			xi += g * (b + a) / 2, yi += g * (c + d) / 2, zi += g, Xc(b = a, c = d)
		}
		var b, c;
		Oi.point = function(d, e) {
			Oi.point = a, Xc(b = d, c = e)
		}
	}
	...
	function $c() {
		function a(a, b) {
			var c = a - d,
				f = b - e,
				g = Math.sqrt(c * c + f * f);
			xi += g * (d + a) / 2, yi += g * (e + b) / 2, zi += g, g = e * a - d * b, Ai += g * (d + a), Bi += g * (e + b), Ci += 3 * g, Xc(d = a, e = b)
		}
		var b, c, d, e;
		Oi.point = function(f, g) {
			Oi.point = a, Xc(b = d = f, c = e = g)
		}, Oi.lineEnd = function() {
			a(b, c)
		}
	}
		...
		function e(b, c, d, h, i, j, k, l, m, n, o, p, q, r) {
			...
			if (u > 4 * f && q--) {
				var v = h + n,
					...
					z = Math.asin(x /= y),
					A = lh(lh(x) - 1) < Fh || lh(d - m) < Fh ? (d + m) / 2 : Math.atan2(w, v),
					B = a(A, z),
					C = B[0],
					D = B[1],
					E = C - b,
					F = D - c,
					G = t * E - s * F;
				(G * G / u > f || lh((s * E + t * F) / u - .5) > .3 || g > h * n + i * o + j * p) && (e(b, c, d, h, i, j, C, D, A, v /= y, w /= y, x, q, r), r.point(C, D), e(C, D, A, v, w, x, k, l, m, n, o, p, q, r))
			}
		}
		var f = .5,
			g = Math.cos(30 * Hh),
	...
	function fd(a) {
		function b(a) {
			return a = h(a[0] * Hh, a[1] * Hh), [a[0] * m + i, j - a[1] * m]
		}

		function c(a) {
			return a = h.invert((a[0] - i) / m, (j - a[1]) / m), a && [a[0] * Ih, a[1] * Ih]
		}
		...
		return b.stream = function(a) {
			...
			return arguments.length ? (u = null == a ? (w = a, Ei) : Nc((w = +a) * Hh), e()) : w
			...
			return arguments.length ? (p = a[0] % 360 * Hh, q = a[1] % 360 * Hh, d()) : [p * Ih, q * Ih]
		}, b.rotate = function(a) {
			return arguments.length ? (r = a[0] % 360 * Hh, s = a[1] % 360 * Hh, t = a.length > 2 ? a[2] % 360 * Hh : 0, d()) : [r * Ih, s * Ih, t * Ih]
		}, Zg.rebind(b, l, "precision"),
		function() {
	...
	function id(a, b) {
		return [a > Ch ? a - Dh : -Ch > a ? a + Dh : a, b]
	}
	...
	function kd(a) {
		return function(b, c) {
			return b += a, [b > Ch ? b - Dh : -Ch > b ? b + Dh : b, c]
		}
	}
	...
	function nd(a, b) {
		...
		return function(e, f, g, h) {
			var i = g * b;
			null != e ? (e = od(c, e), f = od(c, f), (g > 0 ? f > e : e > f) && (e += g * Dh)) : (e = a + g * Dh, f = a - .5 * i);
	...
	function od(a, b) {
		...
		c[0] -= a, tc(c);
		var d = Y(-c[1]);
		return ((-c[2] < 0 ? -d : d) + 2 * Math.PI - Fh) % (2 * Math.PI)
	}

	function pd(a, b, c) {
		var d = Zg.range(a, b - Fh, c)
			.concat(b);
		return function(a) {
		...
		var e = Math.cos(b),
			...
			o = m ? function(a) {
				var b = Math.sin(a *= m) * n,
					...
					e = c * j + b * l,
					g = c * f + b * h;
				return [Math.atan2(e, d) * Ih, Math.atan2(g, Math.sqrt(d * d + e * e)) * Ih]
		} : function() {
			return [a * Ih, b * Ih]
		};
	...
	function ud() {
		function a(a, e) {
			var f = Math.sin(e *= Hh),
				...
				h = lh((a *= Hh) - b),
				i = Math.cos(h);
			Pi += Math.atan2(Math.sqrt((h = g * Math.sin(h)) * h + (h = d * f - c * g * i) * h), c * f + d * g * i), b = a, c = f, d = g
		}
		var b, c, d;
		Qi.point = function(e, f) {
			b = e * Hh, c = Math.sin(f *= Hh), d = Math.cos(f), Qi.point = a
		}, Qi.lineEnd = function() {
			Qi.point = Qi.lineEnd = p
		}
	}
	...
	function wd(a, b) {
		...
		return f ? (c.invert = function(a, b) {
			...
			return [Math.atan2(a, c) / f, 2 * Math.atan(Math.pow(g / d, 1 / f)) - Eh]
		}, c) : yd
	}
	...
	function xd(a, b) {
		...
		var d = Math.cos(a),
			...
			f = d / e + a;
		return lh(e) < Fh ? hd : (c.invert = function(a, b) {
			var c = f - b;
	...
	function yd(a, b) {
		return [a, Math.log(Math.tan(Ch / 4 + b / 2))]
	}
	...
	function Ad(a, b) {
		return [Math.log(Math.tan(Ch / 4 + b / 2)), -a]
	}
	...
	function Kd(a) {
		Ud(a), Zi.remove(a), aj.push(a), be(a)
	}
	...
	function Ld(a) {
		var b = a.circle,
			...
			h = [a];
		Kd(a);
		for (var i = f; i.circle && lh(c - i.circle.x) < Fh && lh(d - i.circle.cy) < Fh;) f = i.P, h.unshift(i), Kd(i), i = f;
		h.unshift(i), Ud(i);
		for (var j = g; j.circle && lh(c - j.circle.x) < Fh && lh(d - j.circle.cy) < Fh;) g = j.N, h.push(j), Kd(j), j = g;
		h.push(j), Ud(j);
		var k, l = h.length;
	...
	function Md(a) {
		for (var b, c, d, e, f = a.x, g = a.y, h = Zi._; h;)
			if (d = Nd(h, g) - f, d > Fh) h = h.L;
			else {
				if (e = f - Od(h, g), !(e > Fh)) {
					d > -Fh ? (b = h.P, c = h) : e > -Fh ? (b = h, c = h.N) : b = c = h;
					break
				}
				if (!h.R) {
					b = h;
		...
		var i = Jd(a);
		if (Zi.insert(b, i), b || c) {
			if (b === c) return Ud(b), c = Jd(b.site), Zi.insert(i, c), i.edge = c.edge = Yd(b.site, i.site), Td(b), void Td(c);
	...
	function Qd(a) {
		for (var b, c, d, e, f, g, h, i, j, k, l = a[0][0], m = a[1][0], n = a[0][1], o = a[1][1], p = Yi, q = p.length; q--;)
			if (f = p[q], f && f.prepare())
				for (h = f.edges, i = h.length, g = 0; i > g;) k = h[g].end(), d = k.x, e = k.y, j = h[++g % i].start(), b = j.x, c = j.y, (lh(d - b) > Fh || lh(e - c) > Fh) && (h.splice(g, 0, new _d(Zd(f.site, k, lh(d - l) < Fh && o - e > Fh ? {
					x: l,
					y: lh(b - l) < Fh ? c : o
				} : lh(e - o) < Fh && m - d > Fh ? {
					x: lh(c - o) < Fh ? b : m,
	...
	function Ud(a) {
		var b = a.circle;
		b && (b.P || ($i = b.N), _i.remove(b), bj.push(b), be(b), a.circle = null)
	}

	function Vd(a) {
		for (var b, c = Xi, d = Oc(a[0][0], a[0][1], a[1][0], a[1][1]), e = c.length; e--;) b = c[e], (!Wd(b, a) || !d(b) || lh(b.a.x - b.b.x) < Fh && lh(b.a.y - b.b.y) < Fh) && (b.a = b.b = null, c.splice(e, 1))
	}
	...
	function Yd(a, b, c, d) {
		var e = new Xd(a, b);
		return Xi.push(e), c && $d(e, a, b, c), d && $d(e, b, a, d), Yi[a.i].edges.push(new _d(e, a, b)), Yi[b.i].edges.push(new _d(e, b, a)), e
	}

	function Zd(a, b, c) {
		var d = new Xd(a, null);
		return d.a = b, d.b = c, Xi.push(d), d
	}
	...
	function fe(a, b) {
		var c, d, e, f = a.sort(ge)
				.pop();
		for (Xi = [], Yi = new Array(a.length), Zi = new ae, _i = new ae;;)
			if (e = $i, f && (!e || f.y < e.y || f.y === e.y && f.x < e.x))(f.x !== c || f.y !== d) && (Yi[f.i] = new Pd(f), Md(f), c = f.x, d = f.y), f = a.pop();
			else {
				if (!e) break;
				Ld(e.arc)
			}
	...
	function pe(a, b) {
		var c, d, e, f = dj.lastIndex = ej.lastIndex = 0,
			g = -1,
			h = [],
			i = [];
		for (a += "", b += "";
			(c = dj.exec(a)) && (d = ej.exec(b));)(e = d.index) > f && (e = b.substring(f, e), h[g] ? h[g] += e : h[++g] = e), (c = c[0]) === (d = d[0]) ? h[g] ? h[g] += d : h[++g] = d : (h[++g] = null, i.push({
			i: g,
			x: oe(c, d)
		})), f = ej.lastIndex;
	...
	function qe(a, b) {
		for (var c, d = Zg.interpolators.length; --d >= 0 && !(c = Zg.interpolators[d](a, b)););
		return c
	}
	...
	function Ce(a, b) {
		var c;
		return arguments.length < 2 && (b = .45), arguments.length ? c = b / Dh * Math.asin(1 / a) : (a = 1, c = b / 4),
		function(d) {
			return 1 + a * Math.pow(2, -10 * d) * Math.sin((d - c) * Dh / b)
		}
	}
	...
	function Je(a) {
		var b = [a.a, a.b],
			...
			e = Ke(b, c),
			f = Le(Me(c, b, -e)) || 0;
		b[0] * c[1] < c[0] * b[1] && (b[0] *= -1, b[1] *= -1, d *= -1, e *= -1), this.rotate = (d ? Math.atan2(b[1], b[0]) : Math.atan2(-c[0], c[1])) * Ih, this.translate = [a.e, a.f], this.scale = [d, f], this.skew = f ? Math.atan2(e, f) * Ih : 0
	}
	...
	function Ye(a, b) {
		return Zg.rebind(a, b, "sort", "children", "value"), a.nodes = a, a.links = af, a
	}
	...
	function af(a) {
		return Zg.merge(a.map(function(a) {
			return (a.children || [])
				.map(function(b) {
					return {
						source: a,
	...
	function kf(a, b) {
		return lf(a, Math.ceil(Math.log(b.length) / Math.LN2 + 1))
	}
	...
	function qf(a, b) {
		var c = a.children;
		if (c && (e = c.length))
			for (var d, e, f = -1; ++f < e;) b(d = qf(c[f], b), a) > 0 && (a = d);
		return a
	}
	...
	function Cf(a) {
		...
		if ((c = a.children) && (j = c.length)) {
			var c, d, e, f, g, h, i, j, k = 1 / 0,
				...
				m = 1 / 0,
				n = -1 / 0;
			if (c.forEach(Df), d = c[0], d.x = -d.r, d.y = 0, b(d), j > 1 && (e = c[1], e.x = e.r, e.y = 0, b(e), j > 2))
				for (f = c[2], Gf(d, e, f), b(f), zf(d, f), d._pack_prev = f, zf(f, e), e = d._pack_next, g = 3; j > g; g++) {
					Gf(d, e, f = c[g]);
					var o = 0,
						p = 1,
						q = 1;
					...
					if (1 == o)
						for (i = d._pack_prev; i !== h._pack_prev && !Bf(i, f); i = i._pack_prev, q++);
					o ? (q > p || p == q && e.r < d.r ? Af(d, e = h) : Af(d = i, e), g--) : (zf(d, f), e = f, b(f))
				}
			var r = (k + l) / 2,
				s = (m + n) / 2,
				t = 0;
	...
	function Ff(a, b, c, d) {
		...
		if (a.x = b += d * a.x, a.y = c += d * a.y, a.r *= d, e)
			for (var f = -1, g = e.length; ++f < g;) Ff(e[f], b, c, d)
	}
	...
	function Jf(a) {
		var b = a.children;
		return b && b.length ? Jf(b[0]) : a
	}

	function Kf(a) {
		var b, c = a.children;
		return c && (b = c.length) ? Kf(c[b - 1]) : a
	}
	...
	function Of(a) {
		return a.rangeExtent ? a.rangeExtent() : Nf(a.range())
	}
	...
	function Sf(a, b, c, d) {
		...
		for (a[h] < a[0] && (a = a.slice()
			.reverse(), b = b.slice()
			.reverse()); ++g <= h;) e.push(c(a[g - 1], a[g])), f.push(d(b[g - 1], b[g]));
		return function(b) {
			var c = Zg.bisect(a, b, 1, h) - 1;
			return f[c](e[c](b))
		}
	}
	...
	function Tf(a, b, c, d) {
		function e() {
			var e = Math.min(a.length, b.length) > 2 ? Sf : Pf,
				i = d ? Pe : Oe;
	...
	function Uf(a, b) {
		return Zg.rebind(a, b, "range", "rangeRound", "interpolate", "clamp")
	}

	function Vf(a, b) {
		return Qf(a, Rf(Wf(a, b)[2]))
	}
	...
	function Xf(a, b) {
		return Zg.range.apply(Zg, Wf(a, b))
	}
	...
	function Yf(a, b, c) {
		...
		if (c) {
			var e = di.exec(c);
			if (e.shift(), "s" === e[8]) {
				var f = Zg.formatPrefix(Math.max(lh(d[0]), lh(d[1])));
				return e[7] || (e[7] = "." + Zf(f.scale(d[2]))), e[8] = "f", c = Zg.format(e.join("")),
				function(a) {
					return c(f.scale(a)) + f.symbol
				}
			}
			e[7] || (e[7] = "." + $f(e[8], d)), c = e.join("")
		} else c = ",." + Zf(d[2]) + "f";
		return Zg.format(c)
	}
	...
	function $f(a, b) {
		var c = Zf(b[2]);
		return a in qj ? Math.abs(c - Zf(Math.max(lh(b[0]), lh(b[1])))) + +("e" !== a) : c - 2 * ("%" === a)
	}
	...
	function _f(a, b, c, d) {
		...
		return g.invert = function(b) {
			...
			return arguments.length ? (c = b[0] >= 0, a.domain((d = b.map(Number))
				.map(e)), g) : d
		}, g.base = function(c) {
			return arguments.length ? (b = +c, a.domain(d.map(e)), g) : b
		}, g.nice = function() {
			var b = Qf(d.map(e), c ? Math : sj);
			...
			if (!arguments.length) return rj;
			arguments.length < 2 ? b = rj : "function" != typeof b && (b = Zg.format(b));
			var d, h = Math.max(.1, a / g.ticks()
					.length),
	...
	function ag(a, b, c) {
		...
		return d.invert = function(b) {
			...
			return arguments.length ? (a.domain((c = b.map(Number))
				.map(e)), d) : c
		}, d.ticks = function(a) {
			return Xf(c, a)
			...
			return d.domain(Vf(c, a))
		}, d.exponent = function(g) {
			return arguments.length ? (e = bg(b = g), f = bg(1 / b), a.domain(c.map(e)), d) : b
		}, d.copy = function() {
			return ag(a.copy(), b, c)
		}, Uf(d, a)
	}
	...
	function dg(c, d) {
		function e() {
			var a = 0,
				b = d.length;
			for (g = []; ++a < b;) g[a - 1] = Zg.quantile(c, a / b);
			return f
		}

		function f(a) {
			return isNaN(a = +a) ? void 0 : d[Zg.bisect(g, a)]
		}
		var g;
		return f.domain = function(d) {
			return arguments.length ? (c = d.filter(b)
				.sort(a), e()) : c
		}, f.range = function(a) {
			return arguments.length ? (d = a, e()) : d
	...
	function fg(a, b) {
		function c(c) {
			return c >= c ? b[Zg.bisect(a, c)] : void 0
		}
	...
	function lg(a) {
		...
		return b.x = function(a) {
			...
			return arguments.length ? (g = "function" == typeof a ? f = a : (f = zj.get(a) || mg)
				.key, b) : g
	...
	function rg(a, b) {
		return a.length < 4 ? mg(a) : a[1] + ug(a.slice(1, a.length - 1), vg(a, b))
	}

	function sg(a, b) {
		return a.length < 3 ? mg(a) : a[0] + ug((a.push(a[0]), a), vg([a[a.length - 2]].concat(a, [a[1]]), b))
	}

	function tg(a, b) {
		return a.length < 3 ? mg(a) : a[0] + ug(a, vg(a, b))
	}

	function ug(a, b) {
		if (b.length < 1 || a.length != b.length && a.length != b.length + 2) return mg(a);
	...
	function wg(a) {
		...
		var b = 1,
			...
			g = [e, e, e, (d = a[1])[0]],
			h = [f, f, f, d[1]],
			i = [e, ",", f, "L", Ag(Cj, g), ",", Ag(Cj, h)];
		for (a.push(a[c - 1]); ++b <= c;) d = a[b], g.shift(), g.push(d[0]), h.shift(), h.push(d[1]), Bg(i, g, h);
		return a.pop(), i.push("L", d), i.join("")
	}

	function xg(a) {
		if (a.length < 4) return mg(a);
		for (var b, c = [], d = -1, e = a.length, f = [0], g = [0]; ++d < 3;) b = a[d], f.push(b[0]), g.push(b[1]);
		for (c.push(Ag(Cj, f) + "," + Ag(Cj, g)), --d; ++d < e;) b = a[d], f.shift(), f.push(b[0]), g.shift(), g.push(b[1]), Bg(c, f, g);
		return c.join("")
	}

	function yg(a) {
		for (var b, c, d = -1, e = a.length, f = e + 4, g = [], h = []; ++d < 4;) c = a[d % e], g.push(c[0]), h.push(c[1]);
		for (b = [Ag(Cj, g), ",", Ag(Cj, h)], --d; ++d < f;) c = a[d % e], g.shift(), g.push(c[0]), h.shift(), h.push(c[1]), Bg(b, g, h);
		return b.join("")
	}
	...
	function Bg(a, b, c) {
		a.push("C", Ag(Aj, b), ",", Ag(Aj, c), ",", Ag(Bj, b), ",", Ag(Bj, c), ",", Ag(Cj, b), ",", Ag(Cj, c))
	}
	...
	function Dg(a) {
		for (var b = 0, c = a.length - 1, d = [], e = a[0], f = a[1], g = d[0] = Cg(e, f); ++b < c;) d[b] = (g + (g = Cg(e = f, f = a[b + 1]))) / 2;
		return d[b] = g, d
	}

	function Eg(a) {
		for (var b, c, d, e, f = [], g = Dg(a), h = -1, i = a.length - 1; ++h < i;) b = Cg(a[h], a[h + 1]), lh(b) < Fh ? g[h] = g[h + 1] = 0 : (c = g[h] / b, d = g[h + 1] / b, e = c * c + d * d, e > 9 && (e = 3 * b / Math.sqrt(e), g[h] = e * c, g[h + 1] = e * d));
		for (h = -1; ++h <= i;) e = (a[Math.min(i, h + 1)][0] - a[Math.max(0, h - 1)][0]) / (6 * (1 + g[h] * g[h])), f.push([e || 0, g[h] * e || 0]);
		return f
	}

	function Fg(a) {
		return a.length < 3 ? mg(a) : a[0] + ug(a, Eg(a))
	}

	function Gg(a) {
		for (var b, c, d, e = -1, f = a.length; ++e < f;) b = a[e], c = b[0], d = b[1] + xj, b[0] = c * Math.cos(d), b[1] = c * Math.sin(d);
		return a
	}
	...
	function Hg(a) {
		...
		return b.x = function(a) {
			...
			return arguments.length ? (i = "function" == typeof a ? h = a : (h = zj.get(a) || mg)
				.key, j = h.reverse || h, k = h.closed ? "M" : "L", b) : i
		}, b.tension = function(a) {
	...
	function Vg(a, b, c) {
		...
		function e(a, c) {
			var d = a[1] - a[0],
				e = d / c,
				f = Zg.bisect(Rj, e);
			return f == Rj.length ? [b.year, Wf(a.map(function(a) {
				return a / 31536e6
			}), c)[2]] : f ? b[e / Rj[f - 1] < Rj[f] / e ? f - 1 : f] : [Uj, Wf(a, c)[2]]
		}
		return d.invert = function(b) {
			return Wg(a.invert(b))
		}, d.domain = function(b) {
			return arguments.length ? (a.domain(b), d) : a.domain()
				.map(Wg)
		}, d.nice = function(a, b) {
			function c(c) {
				return !isNaN(c) && !a.range(c, Wg(+c + 1), b)
					.length
			}
			var f = d.domain(),
				g = Nf(f),
				h = null == a ? e(g, 10) : "number" == typeof a && e(g, a);
			return h && (a = h[0], b = h[1]), d.domain(Qf(f, b > 1 ? {
				floor: function(b) {
					for (; c(b = a.floor(b));) b = Wg(b - 1);
					return b
				},
				ceil: function(b) {
					for (; c(b = a.ceil(b));) b = Wg(+b + 1);
					return b
				}
			} : a))
			...
			return f && (a = f[0], b = f[1]), a.range(c[0], Wg(+c[1] + 1), 1 > b ? 1 : b)
		}, d.tickFormat = function() {
			return c
		}, d.copy = function() {
			return Vg(a.copy(), b, c)
		}, Uf(d, a)
	}
	...
	function Yg(a) {
		var b = ah.createRange();
		return b.selectNode(ah.body), b.createContextualFragment(a.responseText)
	}
	var Zg = {
		version: "3.4.6"
	};
	...
	var $g = [].slice,
		...
		bh = ah.documentElement,
		ch = window;
	try {
		_g(bh.childNodes)[0].nodeType
	} catch (dh) {
		_g = function(a) {
	...
	try {
		...
		var fh = ch.Element.prototype,
			gh = fh.setAttribute,
			hh = fh.setAttributeNS,
			ih = ch.CSSStyleDeclaration.prototype,
			jh = ih.setProperty;
		fh.setAttribute = function(a, b) {
			gh.call(this, a, b + "")
		}, fh.setAttributeNS = function(a, b, c) {
			hh.call(this, a, b, c + "")
		}, ih.setProperty = function(a, b, c) {
			jh.call(this, a, b + "", c)
		}
	}
	Zg.ascending = a, Zg.descending = function(a, b) {
		...
		return arguments.length > 1 && (c = c.map(d)), c = c.filter(b), c.length ? Zg.quantile(c.sort(a), .5) : void 0
	};
	var kh = c(a);
	Zg.bisectLeft = kh.left, Zg.bisect = Zg.bisectRight = kh.right, Zg.bisector = function(b) {
		return c(1 === b.length ? function(c, d) {
			return a(b(c), d)
		} : b)
	}, Zg.shuffle = function(a) {
		for (var b, c, d = a.length; d;) c = 0 | Math.random() * d--, b = a[d], a[d] = a[c], a[c] = b;
		return a
	}, Zg.permute = function(a, b) {
		...
		for (var a = -1, b = Zg.min(arguments, d), c = new Array(b); ++a < b;)
			for (var e, f = -1, g = c[a] = new Array(e); ++f < e;) g[f] = arguments[f][a];
		return c
	}, Zg.transpose = function(a) {
		return Zg.zip.apply(Zg, a)
	}, Zg.keys = function(a) {
		var b = [];
		for (var c in a) b.push(c);
		return b
	}, Zg.values = function(a) {
		var b = [];
		for (var c in a) b.push(a[c]);
		return b
	}, Zg.entries = function(a) {
		var b = [];
	...
	Zg.range = function(a, b, c) {
		...
		empty: l,
		forEach: function(a) {
			for (var b in this) b.charCodeAt(0) === nh && a.call(this, b.substring(1), this[b])
		}
	});
	var mh = "\x00",
		nh = mh.charCodeAt(0);
	Zg.nest = function() {
		...
		empty: l,
		forEach: function(a) {
			for (var b in this) b.charCodeAt(0) === nh && a.call(this, b.substring(1))
		}
	}), Zg.behavior = {}, Zg.rebind = function(a, b) {
		for (var c, d = 1, e = arguments.length; ++d < e;) a[c = arguments[d]] = n(a, b, b[c]);
		return a
	};
	var oh = ["webkit", "ms", "moz", "Moz", "o", "O"];
	Zg.dispatch = function() {
	...
	}, Zg.event = null, Zg.requote = function(a) {
		return a.replace(ph, "\\$&")
	};
	var ph = /[\\\^\$\*\+\?\|\[\]\(\)\.\{\}]/g,
		qh = {}.__proto__ ? function(a, b) {
			a.__proto__ = b
	} : function(a, b) {
		...
		}, th = bh[o(bh, "matchesSelector")],
		uh = function(a, b) {
			return th.call(a, b)
		};
	"function" == typeof Sizzle && (rh = function(a, b) {
		return Sizzle(a, b)[0] || null
	}, sh = Sizzle, uh = Sizzle.matchesSelector), Zg.selection = function() {
		return yh
	};
	var vh = Zg.selection.prototype = [];
	vh.select = function(a) {
		var b, c, d, e, f = [];
		a = w(a);
		for (var g = -1, h = this.length; ++g < h;) {
			f.push(b = []), b.parentNode = (d = this[g])
				.parentNode;
			for (var i = -1, j = d.length; ++i < j;)(e = d[i]) ? (b.push(c = a.call(e, e.__data__, i, g)), c && "__data__" in e && (c.__data__ = e.__data__)) : b.push(null)
		}
		return v(f)
	}, vh.selectAll = function(a) {
		var b, c, d = [];
		a = x(a);
		for (var e = -1, f = this.length; ++e < f;)
			for (var g = this[e], h = -1, i = g.length; ++h < i;)(c = g[h]) && (d.push(b = _g(a.call(c, c.__data__, h, e))), b.parentNode = c);
		return v(d)
	};
	var wh = {
	...
	Zg.ns = {
		...
		qualify: function(a) {
			var b = a.indexOf(":"),
				c = a;
			return b >= 0 && (c = a.substring(0, b), a = a.substring(b + 1)), wh.hasOwnProperty(c) ? {
				space: wh[c],
				local: a
			} : a
		}
	}, vh.attr = function(a, b) {
		if (arguments.length < 2) {
			if ("string" == typeof a) {
				var c = this.node();
				return a = Zg.ns.qualify(a), a.local ? c.getAttributeNS(a.space, a.local) : c.getAttribute(a)
			}
			for (b in a) this.each(y(b, a[b]));
			return this
		}
		return this.each(y(a, b))
	}, vh.classed = function(a, b) {
		if (arguments.length < 2) {
			if ("string" == typeof a) {
				var c = this.node(),
					d = (a = B(a))
		...
		if (3 > d) {
			...
			if (2 > d) return ch.getComputedStyle(this.node(), null)
				.getPropertyValue(a);
			c = ""
		}
		return this.each(E(a, b, c))
	}, vh.property = function(a, b) {
		if (arguments.length < 2) {
		...
		var d, e, f = -1,
			h = this.length;
		if (!arguments.length) {
			for (a = new Array(h = (d = this[0])
				.length); ++f < h;)(e = d[f]) && (a[f] = e.__data__);
			return a
		}
		var i = L([]),
			j = v([]),
	...
	var xh = [];
	Zg.selection.enter = L, Zg.selection.enter.prototype = xh, xh.append = vh.append, xh.empty = vh.empty, xh.node = vh.node, xh.call = vh.call, xh.size = vh.size, xh.select = function(a) {
		for (var b, c, d, e, f, g = [], h = -1, i = this.length; ++h < i;) {
			d = (e = this[h])
				.update, g.push(b = []), b.parentNode = e.parentNode;
			for (var j = -1, k = e.length; ++j < k;)(f = e[j]) ? (b.push(d[j] = c = a.call(e.parentNode, f.__data__, j, h)), c.__data__ = f.__data__) : b.push(null)
		}
		return v(g)
	}, xh.insert = function(a, b) {
		return arguments.length < 2 && (b = M(this)), vh.insert.call(this, a, b)
	}, vh.transition = function() {
		for (var a, b, c = Ej || ++Jj, d = [], e = Fj || {
				time: Date.now(),
				ease: xe,
				delay: 0,
				duration: 250
			...
			d.push(a = []);
			for (var h = this[f], i = -1, j = h.length; ++i < j;)(b = h[i]) && Rg(b, i, c, e), a.push(b)
		}
		return Og(d, c)
	}, vh.interrupt = function() {
		return this.each(N)
	}, Zg.select = function(a) {
		var b = ["string" == typeof a ? rh(a, ah) : a];
		return b.parentNode = bh, v([b])
	}, Zg.selectAll = function(a) {
		var b = _g("string" == typeof a ? sh(a, ah) : a);
		return b.parentNode = bh, v([b])
	};
	var yh = Zg.select(bh);
	vh.on = function(a, b, c) {
		var d = arguments.length;
		if (3 > d) {
			if ("string" != typeof a) {
				2 > d && (b = !1);
	...
	zh.forEach(function(a) {
		"on" + a in ah && zh.remove(a)
	});
	var Ah = "onselectstart" in ah ? null : o(bh.style, "userSelect"),
		Bh = 0;
	Zg.mouse = function(a) {
		return S(a, t())
	}, Zg.touches = function(a, b) {
		return arguments.length < 2 && (b = t()
			.touches), b ? _g(b)
			.map(function(b) {
				var c = S(a, b);
				return c.identifier = b.identifier, c
			}) : []
	}, Zg.behavior.drag = function() {
		function a() {
			this.on("mousedown.drag", e)
				.on("touchstart.drag", f)
		}
		...
		function b(a, b, e, f, g) {
			return function() {
				...
				function i() {
					b(m, p) && (r.on(f + q, null)
						.on(g + q, null), s(o && Zg.event.target === l), n({
							type: "dragend"
						}))
				}
				var j, k = this,
		...
		var c = u(a, "drag", "dragstart", "dragend"),
			d = null,
			e = b(p, Zg.mouse, V, "mousemove", "mouseup"),
			f = b(T, Zg.touch, U, "touchmove", "touchend");
	...
	var Ch = Math.PI,
		...
		Kh = 2,
		Lh = 4;
	Zg.interpolateZoom = function(a, b) {
		function c(a) {
			var b = a * s;
			if (r) {
				var c = _(p),
					g = f / (Kh * m) * (c * ab(Jh * b + p) - $(p));
				return [d + g * j, e + g * k, f * c / _(Jh * b + p)]
			}
			return [d + a * j, e + a * k, f * Math.exp(Jh * b)]
		}
		var d = a[0],
			e = a[1],
			f = a[2],
		...
		function f() {
			v && v.domain(t.range()
				...
				.map(t.invert)), x && x.domain(w.range()
				.map(function(a) {
					return (a - y.y) / y.k
				})
				.map(w.invert))
		...
		function j() {
			function a() {
				k = 1, e(Zg.mouse(d), n), h(j)
			}

			function c() {
				l.on(C, ch === d ? m : null)
					.on(D, null), o(k && Zg.event.target === f), i(j)
			}
			var d = this,
				f = Zg.event.target,
				j = F.of(d, arguments),
		...
		function k() {
			...
			function c() {
				for (var b = Zg.event.changedTouches, c = 0, f = b.length; f > c; ++c) p[b[c].identifier] = null;
				var g = a(),
					i = Date.now();
				if (1 === g.length) {
					if (500 > i - r) {
			...
			function f() {
				for (var a, b, c, f, g = Zg.touches(n), i = 0, j = g.length; j > i; ++i, f = null)
			...
			function l() {
				if (Zg.event.touches.length) {
					for (var b = Zg.event.changedTouches, c = 0, d = b.length; d > c; ++c) delete p[b[c].identifier];
					for (var e in p) return void a()
				}
				w.on(t, null), x.on(B, j)
					.on(E, k), z(), i(o)
			}
			var m, n = this,
				o = F.of(n, arguments),
				p = {}, q = 0,
				t = ".zoom-" + Zg.event.changedTouches[0].identifier,
				u = "touchmove" + t,
				v = "touchend" + t,
				w = Zg.select(Zg.event.target)
					.on(u, f)
					.on(v, l),
				x = Zg.select(n)
					.on(B, null)
		...
		function l() {
			...
			var c = p || Zg.mouse(this);
			o || (o = b(c)), d(Math.pow(2, .002 * Mh()) * y.k), e(c, o), h(a)
		}
		...
		function n() {
			...
			g(a), d(Math.pow(2, Zg.event.shiftKey ? Math.ceil(j) - 1 : Math.floor(j) + 1)), e(c, f), h(a), i(a)
		}
		...
		return a.event = function(a) {
				...
				Ej ? Zg.select(this)
					...
					.tween("zoom:zoom", function() {
						var c = z[0],
							...
							e = c / 2,
							f = d / 2,
							g = Zg.interpolateZoom([(e - y.x) / y.k, (f - y.y) / y.k, c / y.k], [(e - b.x) / b.k, (f - b.y) / b.k, c / b.k]);
						return function(b) {
							var d = g(b),
								i = c / d[2];
							this.__chart__ = y = {
			...
			return arguments.length ? (A = null == b ? Nh : [+b[0], +b[1]], a) : A
		}, a.center = function(b) {
	...
	var Mh, Nh = [0, 1 / 0],
		Oh = "onwheel" in ah ? (Mh = function() {
			return -Zg.event.deltaY * (Zg.event.deltaMode ? 120 : 1)
		}, "wheel") : "onmousewheel" in ah ? (Mh = function() {
			return Zg.event.wheelDelta
		}, "mousewheel") : (Mh = function() {
			return -Zg.event.detail
		}, "MozMousePixelScroll");
	cb.prototype.toString = function() {
		return this.rgb() + ""
	}, Zg.hsl = function(a, b, c) {
		return 1 === arguments.length ? a instanceof eb ? db(a.h, a.s, a.l) : vb("" + a, wb, db) : db(+a, +b, +c)
	};
	var Ph = eb.prototype = new cb;
	...
	}, Zg.hcl = function(a, b, c) {
		return 1 === arguments.length ? a instanceof hb ? gb(a.h, a.c, a.l) : a instanceof kb ? mb(a.l, a.a, a.b) : mb((a = xb((a = Zg.rgb(a))
				.r, a.g, a.b))
			.l, a.a, a.b) : gb(+a, +b, +c)
	};
	var Qh = hb.prototype = new cb;
	Qh.brighter = function(a) {
		return gb(this.h, this.c, Math.min(100, this.l + Rh * (arguments.length ? a : 1)))
	}, Qh.darker = function(a) {
		return gb(this.h, this.c, Math.max(0, this.l - Rh * (arguments.length ? a : 1)))
	}, Qh.rgb = function() {
		return ib(this.h, this.c, this.l)
			.rgb()
	}, Zg.lab = function(a, b, c) {
		return 1 === arguments.length ? a instanceof kb ? jb(a.l, a.a, a.b) : a instanceof hb ? ib(a.l, a.c, a.h) : xb((a = Zg.rgb(a))
			.r, a.g, a.b) : jb(+a, +b, +c)
	};
	var Rh = 18,
		Sh = .95047,
		Th = 1,
		Uh = 1.08883,
		Vh = kb.prototype = new cb;
	Vh.brighter = function(a) {
		return jb(Math.min(100, this.l + Rh * (arguments.length ? a : 1)), this.a, this.b)
	}, Vh.darker = function(a) {
		return jb(Math.max(0, this.l - Rh * (arguments.length ? a : 1)), this.a, this.b)
	}, Vh.rgb = function() {
		return lb(this.l, this.a, this.b)
	}, Zg.rgb = function(a, b, c) {
		return 1 === arguments.length ? a instanceof tb ? sb(a.r, a.g, a.b) : vb("" + a, sb, fb) : sb(~~a, ~~b, ~~c)
	};
	var Wh = tb.prototype = new cb;
	...
	Xh.forEach(function(a, b) {
		Xh.set(a, qb(b))
	}), Zg.functor = Ab, Zg.xhr = Cb(Bb), Zg.dsv = function(a, b) {
		function c(a, c, f) {
		...
		return c.parse = function(a, b) {
			...
			function c() {
				...
				if (34 === a.charCodeAt(b)) {
					...
					return 13 === d ? (e = !0, 10 === a.charCodeAt(c + 2) && ++k) : 10 === d && (e = !0), a.substring(b + 1, c)
						.replace(/""/g, '"')
				}
				for (; j > k;) {
	...
	}, Zg.csv = Zg.dsv(",", "text/csv"), Zg.tsv = Zg.dsv("	", "text/tab-separated-values"), Zg.touch = function(a, b, c) {
		if (arguments.length < 3 && (c = b, b = t()
			.changedTouches), b)
			for (var d, e = 0, f = b.length; f > e; ++e)
				if ((d = b[e])
					.identifier === c) return S(a, d)
	};
	var Yh, Zh, $h, _h, ai, bi = ch[o(ch, "requestAnimationFrame")] || function(a) {
		setTimeout(a, 17)
	};
	Zg.timer = function(a, b, c) {
		var d = arguments.length;
		...
		Zh ? Zh.n = f : Yh = f, Zh = f, $h || (_h = clearTimeout(_h), $h = 1, bi(Fb))
	}, Zg.timer.flush = function() {
		Gb(), Hb()
	}, Zg.round = function(a, b) {
		return b ? Math.round(a * (b = Math.pow(10, b))) / b : Math.round(a)
	};
	var ci = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"].map(Jb);
	Zg.formatPrefix = function(a, b) {
		var c = 0;
		return a && (0 > a && (a *= -1), b && (a = Zg.round(a, Ib(a, b))), c = 1 + Math.floor(1e-12 + Math.log(a) / Math.LN10), c = Math.max(-24, Math.min(24, 3 * Math.floor((c - 1) / 3)))), ci[8 + c / 3]
	};
	var di = /(?:([^{])?([<>=^]))?([+\- ])?([$#])?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i,
		ei = Zg.map({
			b: function(a) {
			...
			r: function(a, b) {
				return (a = Zg.round(a, Ib(a, b)))
					.toFixed(Math.max(0, Math.min(20, Ib(a * (1 + 1e-15), b))))
			}
		}),
		fi = Zg.time = {}, gi = Date;
	Mb.prototype = {
		...
		setDate: function() {
			hi.setUTCDate.apply(this._, arguments)
		},
		setDay: function() {
			hi.setUTCDay.apply(this._, arguments)
		},
		setFullYear: function() {
			hi.setUTCFullYear.apply(this._, arguments)
		},
		setHours: function() {
			hi.setUTCHours.apply(this._, arguments)
		},
		setMilliseconds: function() {
			hi.setUTCMilliseconds.apply(this._, arguments)
		},
		setMinutes: function() {
			hi.setUTCMinutes.apply(this._, arguments)
		},
		setMonth: function() {
			hi.setUTCMonth.apply(this._, arguments)
		},
		setSeconds: function() {
			hi.setUTCSeconds.apply(this._, arguments)
		},
		setTime: function() {
			hi.setTime.apply(this._, arguments)
		}
	};
	var hi = Date.prototype;
	fi.year = Nb(function(a) {
		return a = fi.day(a), a.setMonth(0, 1), a
	}, function(a, b) {
		a.setFullYear(a.getFullYear() + b)
	}, function(a) {
		return a.getFullYear()
	}), fi.years = fi.year.range, fi.years.utc = fi.year.utc.range, fi.day = Nb(function(a) {
		var b = new gi(2e3, 0);
		...
		return a.getDate() - 1
	}), fi.days = fi.day.range, fi.days.utc = fi.day.utc.range, fi.dayOfYear = function(a) {
		var b = fi.year(a);
		...
		b = 7 - b;
		var c = fi[a] = Nb(function(a) {
			return (a = fi.day(a))
				.setDate(a.getDate() - (a.getDay() + b) % 7), a
		}, function(a, b) {
			a.setDate(a.getDate() + 7 * Math.floor(b))
		}, function(a) {
			var c = fi.year(a)
				.getDay();
			return Math.floor((fi.dayOfYear(a) + (c + b) % 7) / 7) - (c !== b)
		});
		fi[a + "s"] = c.range, fi[a + "s"].utc = c.utc.range, fi[a + "OfYear"] = function(a) {
			var c = fi.year(a)
				.getDay();
			return Math.floor((fi.dayOfYear(a) + (c + b) % 7) / 7)
		}
	}), fi.week = fi.sunday, fi.weeks = fi.sunday.range, fi.weeks.utc = fi.sunday.utc.range, fi.weekOfYear = fi.sundayOfYear;
	var ii = {
		"-": "",
		_: " ",
		0: "0"
	...
	Zg.format = li.numberFormat, Zg.geo = {}, ic.prototype = {
		s: 0,
		t: 0,
		add: function(a) {
			jc(a, this.t, mi), jc(mi.s, this.s, this), this.s ? this.t += mi.t : this.s = mi.t
		},
		reset: function() {
			this.s = this.t = 0
		},
	...
	var mi = new ic;
	Zg.geo.stream = function(a, b) {
		a && ni.hasOwnProperty(a.type) ? ni[a.type](a, b) : kc(a, b)
	};
	var ni = {
	...
	Zg.geo.area = function(a) {
		return pi = 0, Zg.geo.stream(a, ri), pi
	};
	var pi, qi = new ic,
		ri = {
			sphere: function() {
			...
			lineEnd: p,
			polygonStart: function() {
				qi.reset(), ri.lineStart = nc
			},
			polygonEnd: function() {
				var a = 2 * qi;
				pi += 0 > a ? 4 * Ch + a : a, ri.lineStart = ri.lineEnd = ri.point = p
			}
		};
	Zg.geo.bounds = function() {
		function a(a, b) {
		...
		function g() {
			e(p, q), ri.lineEnd(), lh(s) > Fh && (k = -(m = 180)), u[0] = k, u[1] = m, r = null
		}
		...
		var k, l, m, n, o, p, q, r, s, t, u, v = {
				...
				lineEnd: d,
				polygonStart: function() {
					v.point = e, v.lineStart = f, v.lineEnd = g, s = 0, ri.polygonStart()
				},
				polygonEnd: function() {
					ri.polygonEnd(), v.point = a, v.lineStart = c, v.lineEnd = d, 0 > qi ? (k = -(m = 180), l = -(n = 90)) : s > Fh ? n = 90 : -Fh > s && (l = -90), u[0] = k, u[1] = m
				}
			};
		return function(a) {
			n = m = -(k = l = 1 / 0), t = [], Zg.geo.stream(a, v);
			var b = t.length;
			if (b) {
				t.sort(i);
	...
	}(), Zg.geo.centroid = function(a) {
		si = ti = ui = vi = wi = xi = yi = zi = Ai = Bi = Ci = 0, Zg.geo.stream(a, Di);
		var b = Ai,
			c = Bi,
			d = Ci,
			e = b * b + c * c + d * d;
		return Gh > e && (b = xi, c = yi, d = zi, Fh > ti && (b = ui, c = vi, d = wi), e = b * b + c * c + d * d, Gh > e) ? [0 / 0, 0 / 0] : [Math.atan2(c, b) * Ih, Z(d / Math.sqrt(e)) * Ih]
	};
	var si, ti, ui, vi, wi, xi, yi, zi, Ai, Bi, Ci, Di = {
			sphere: p,
			point: wc,
			lineStart: yc,
			lineEnd: zc,
		...
		}, Ei = Fc(Bc, Kc, Mc, [-Ch, -Ch / 2]),
		Fi = 1e9;
	Zg.geo.clipExtent = function() {
		var a, b, c, d, e, f, g = {
				stream: function(a) {
	...
	}, (Zg.geo.conicEqualArea = function() {
		return Rc(Sc)
	})
		.raw = Sc, Zg.geo.albers = function() {
			return Zg.geo.conicEqualArea()
				.rotate([96, 0])
				.center([-.6, 38.7])
				.parallels([29.5, 45.5])
				.scale(1070)
	}, Zg.geo.albersUsa = function() {
		function a(a) {
			var f = a[0],
				g = a[1];
			return b = null, c(f, g), b || (d(f, g), b) || e(f, g), b
		}
		var b, c, d, e, f = Zg.geo.albers(),
			g = Zg.geo.conicEqualArea()
				.rotate([154, 0])
				.center([-2, 58.5])
				.parallels([55, 65]),
			h = Zg.geo.conicEqualArea()
				.rotate([157, 0])
				.center([-3, 19.9])
				.parallels([8, 18]),
			i = {
		...
		return a.invert = function(a) {
			var b = f.scale(),
				...
				d = (a[0] - c[0]) / b,
				e = (a[1] - c[1]) / b;
			return (e >= .12 && .234 > e && d >= -.425 && -.214 > d ? g : e >= .166 && .234 > e && d >= -.214 && -.115 > d ? h : f)
				.invert(a)
		}, a.stream = function(a) {
			var b = f.stream(a),
				c = g.stream(a),
			...
			var j = f.scale(),
				k = +b[0],
				l = +b[1];
			return c = f.translate(b)
				.clipExtent([
					[k - .455 * j, l - .238 * j],
					[k + .455 * j, l + .238 * j]
				])
				.stream(i)
				.point, d = g.translate([k - .307 * j, l + .201 * j])
				.clipExtent([
					[k - .425 * j + Fh, l + .12 * j + Fh],
					[k - .214 * j - Fh, l + .234 * j - Fh]
				])
				.stream(i)
				.point, e = h.translate([k - .205 * j, l + .212 * j])
				.clipExtent([
					[k - .214 * j + Fh, l + .166 * j + Fh],
					[k - .115 * j - Fh, l + .234 * j - Fh]
				])
				.stream(i)
				.point, a
		}, a.scale(1070)
	};
	var Gi, Hi, Ii, Ji, Ki, Li, Mi = {
			point: p,
			lineStart: p,
			lineEnd: p,
			polygonStart: function() {
				Hi = 0, Mi.lineStart = Tc
			},
			polygonEnd: function() {
				Mi.lineStart = Mi.lineEnd = Mi.point = p, Gi += lh(Hi / 2)
			}
		}, Ni = {
			point: Uc,
			lineStart: p,
			...
			polygonEnd: function() {
				Oi.point = Xc, Oi.lineStart = Yc, Oi.lineEnd = Zc
			}
		};
	Zg.geo.path = function() {
		function a(a) {
			return a && ("function" == typeof h && f.pointRadius(+h.apply(this, arguments)), g && g.valid || (g = e(f)), Zg.geo.stream(a, g)), f.result()
		}
		...
		return a.area = function(a) {
			return Gi = 0, Zg.geo.stream(a, e(Mi)), Gi
		}, a.centroid = function(a) {
			return ui = vi = wi = xi = yi = zi = Ai = Bi = Ci = 0, Zg.geo.stream(a, e(Oi)), Ci ? [Ai / Ci, Bi / Ci] : zi ? [xi / zi, yi / zi] : wi ? [ui / wi, vi / wi] : [0 / 0, 0 / 0]
		}, a.bounds = function(a) {
			return Ki = Li = -(Ii = Ji = 1 / 0), Zg.geo.stream(a, e(Ni)), [
				[Ii, Ji],
				[Ki, Li]
			]
		...
		}, a.projection(Zg.geo.albersUsa())
			.context(null)
	}, Zg.geo.transform = function(a) {
		return {
			stream: function(b) {
				var c = new cd(b);
	...
	}, Zg.geo.projection = ed, Zg.geo.projectionMutator = fd, (Zg.geo.equirectangular = function() {
		return ed(hd)
	})
		.raw = hd.invert = hd, Zg.geo.rotation = function(a) {
			function b(b) {
				return b = a(b[0] * Hh, b[1] * Hh), b[0] *= Ih, b[1] *= Ih, b
			}
			return a = jd(a[0] % 360 * Hh, a[1] * Hh, a.length > 2 ? a[2] * Hh : 0), b.invert = function(b) {
				return b = a.invert(b[0] * Hh, b[1] * Hh), b[0] *= Ih, b[1] *= Ih, b
			}, b
	}, id.invert = hd, Zg.geo.circle = function() {
		function a() {
			var a = "function" == typeof d ? d.apply(this, arguments) : d,
				b = jd(-a[0] * Hh, -a[1] * Hh, 0)
					.invert,
				e = [];
			return c(null, null, 1, {
				point: function(a, c) {
					e.push(a = b(a, c)), a[0] *= Ih, a[1] *= Ih
				}
			}), {
				type: "Polygon",
				coordinates: [e]
		...
		return a.origin = function(b) {
			...
			return arguments.length ? (c = nd((b = +d) * Hh, e * Hh), a) : b
		}, a.precision = function(d) {
			return arguments.length ? (c = nd(b * Hh, (e = +d) * Hh), a) : e
		}, a.angle(90)
	}, Zg.geo.distance = function(a, b) {
		var c, d = (b[0] - a[0]) * Hh,
			e = a[1] * Hh,
			f = b[1] * Hh,
			g = Math.sin(d),
		...
		function b() {
			return Zg.range(Math.ceil(f / q) * q, e, q)
				.map(m)
				.concat(Zg.range(Math.ceil(j / r) * r, i, r)
					.map(n))
				.concat(Zg.range(Math.ceil(d / o) * o, c, o)
					.filter(function(a) {
						return lh(a % q) > Fh
					})
					.map(k))
				.concat(Zg.range(Math.ceil(h / p) * p, g, p)
					.filter(function(a) {
						return lh(a % r) > Fh
					})
					.map(l))
		...
		return a.lines = function() {
			...
			return arguments.length ? a.majorExtent(b)
				.minorExtent(b) : a.minorExtent()
			...
			return arguments.length ? a.majorStep(b)
				.minorStep(b) : a.minorStep()
		...
		return a.distance = function() {
			return Zg.geo.distance(b || d.apply(this, arguments), c || e.apply(this, arguments))
		}, a.source = function(c) {
	...
	}, Zg.geo.interpolate = function(a, b) {
		return td(a[0] * Hh, a[1] * Hh, b[0] * Hh, b[1] * Hh)
	}, Zg.geo.length = function(a) {
		return Pi = 0, Zg.geo.stream(a, Qi), Pi
	};
	var Pi, Qi = {
			sphere: p,
			point: p,
	...
	(Zg.geo.azimuthalEqualArea = function() {
		return ed(Ri)
	})
		.raw = Ri;
	...
	(Zg.geo.azimuthalEquidistant = function() {
		return ed(Si)
	})
		.raw = Si, (Zg.geo.conicConformal = function() {
			return Rc(wd)
		})
		.raw = wd, (Zg.geo.conicEquidistant = function() {
			return Rc(xd)
		})
		.raw = xd;
	var Ti = vd(function(a) {
		return 1 / a
	}, Math.atan);
	(Zg.geo.gnomonic = function() {
		return ed(Ti)
	})
		.raw = Ti, yd.invert = function(a, b) {
			return [a, 2 * Math.atan(Math.exp(b)) - Eh]
	}, (Zg.geo.mercator = function() {
		return zd(yd)
	})
		.raw = yd;
	var Ui = vd(function() {
	...
	(Zg.geo.orthographic = function() {
		return ed(Ui)
	})
		.raw = Ui;
	var Vi = vd(function(a) {
		return 1 / (1 + a)
	}, function(a) {
		return 2 * Math.atan(a)
	});
	(Zg.geo.stereographic = function() {
		return ed(Vi)
	})
		.raw = Vi, Ad.invert = function(a, b) {
			return [-b, 2 * Math.atan(Math.exp(a)) - Eh]
	}, (Zg.geo.transverseMercator = function() {
		var a = zd(Ad),
			b = a.center,
			c = a.rotate;
		...
		.raw = Ad, Zg.geom = {}, Zg.geom.hull = function(a) {
			function b(a) {
	...
	}, Zg.geom.polygon = function(a) {
		return qh(a, Wi), a
	};
	var Wi = Zg.geom.polygon.prototype = [];
	Wi.area = function() {
		for (var a, b = -1, c = this.length, d = this[c - 1], e = 0; ++b < c;) a = d, d = this[b], e += a[1] * d[0] - a[0] * d[1];
		return .5 * e
	}, Wi.centroid = function(a) {
		var b, c, d = -1,
			e = this.length,
			f = 0,
			g = 0,
	...
	Pd.prototype.prepare = function() {
		...
		function c(a) {
			return a.map(function(a, b) {
				return {
					x: Math.round(f(a, b) / Fh) * Fh,
					y: Math.round(g(a, b) / Fh) * Fh,
					i: b
				}
			})
		}
		...
		return a ? b(a) : (b.links = function(a) {
			...
			return arguments.length ? (h = null == a ? cj : a, b) : h === cj ? null : h
		}, b.size = function(a) {
	...
	Zg.geom.delaunay = function(a) {
		return Zg.geom.voronoi()
			.triangles(a)
	}, Zg.geom.quadtree = function(a, b, c, d, e) {
		function f(a) {
				...
				if (!isNaN(c) && !isNaN(d))
					if (a.leaf) {
						var i = a.x,
							k = a.y;
						if (null != i)
							if (lh(i - c) + lh(k - d) < .01) j(a, b, c, d, e, f, g, h);
							else {
								var l = a.point;
	...
	}, Zg.interpolateRgb = me, Zg.interpolateObject = ne, Zg.interpolateNumber = oe, Zg.interpolateString = pe;
	var dj = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,
		ej = new RegExp(dj.source, "g");
	Zg.interpolate = qe, Zg.interpolators = [
		function(a, b) {
			var c = typeof b;
			return ("string" === c ? Xh.has(b) || /^(#|rgb\(|hsl\()/.test(b) ? me : pe : b instanceof cb ? me : Array.isArray(b) ? re : "object" === c && isNaN(b) ? ne : oe)(a, b)
		}
	], Zg.interpolateArray = re;
	var fj = function() {
		return Bb
	}, gj = Zg.map({
			linear: fj,
	...
	Zg.ease = function(a) {
		...
		return c = gj.get(c) || fj, d = hj.get(d) || Bb, se(d(c.apply(null, $g.call(arguments, 1))))
	}, Zg.interpolateHcl = Fe, Zg.interpolateHsl = Ge, Zg.interpolateLab = He, Zg.interpolateRound = Ie, Zg.transform = function(a) {
		var b = ah.createElementNS(Zg.ns.prefix.svg, "g");
		return (Zg.transform = function(a) {
			if (null != a) {
				b.setAttribute("transform", a);
				var c = b.transform.baseVal.consolidate()
			}
			return new Je(c ? c.matrix : ij)
		})(a)
	...
	Zg.interpolateTransform = Ne, Zg.layout = {}, Zg.layout.bundle = function() {
		return function(a) {
			for (var b = [], c = -1, d = a.length; ++c < d;) b.push(Qe(a[c]));
			return b
		}
	}, Zg.layout.chord = function() {
		function a() {
			var a, j, l, m, n, o = {}, p = [],
				q = Zg.range(f),
				r = [];
			for (c = [], d = [], a = 0, m = -1; ++m < f;) {
				...
				p.push(j), r.push(Zg.range(f)), a += j
			}
		...
		function b(a) {
			a.px = Zg.event.x, a.py = Zg.event.y, h.resume()
		}
		var c, d, e, f, g, h = {}, i = Zg.dispatch("start", "tick", "end"),
			j = [1, 1],
			k = .9,
			l = jj,
			m = kj,
		...
		return h.tick = function() {
			...
			if (n)
				for (Xe(b = Zg.geom.quadtree(r), d, g), c = -1; ++c < v;)(h = r[c])
					.fixed || b.visit(a(h));
			...
			if (e = [], "function" == typeof l)
				...
				for (b = 0; k > b; ++b) e[b] = l; if (f = [], "function" == typeof m)
				for (b = 0; k > b; ++b) f[b] = +m.call(this, s[b], b);
			else
				for (b = 0; k > b; ++b) f[b] = m; if (g = [], "function" == typeof n)
			...
			return c || (c = Zg.behavior.drag()
				.origin(Bb)
				.on("dragstart.force", Te)
				.on("drag.force", b)
				.on("dragend.force", Ue)), arguments.length ? void this.on("mouseover.force", Ve)
	...
	Zg.layout.hierarchy = function() {
		...
		var d = Zg.layout.hierarchy(),
			e = [1, 1];
		return c.size = function(a) {
			return arguments.length ? (e = a, c) : e
		}, Ye(c, d)
	}, Zg.layout.pie = function() {
		function a(f) {
			var g = f.map(function(c, d) {
				return +b.call(a, c, d)
			}),
				h = +("function" == typeof d ? d.apply(this, arguments) : d),
				i = (("function" == typeof e ? e.apply(this, arguments) : e) - h) / Zg.sum(g),
				j = Zg.range(f.length);
			null != c && j.sort(c === mj ? function(a, b) {
				return g[b] - g[a]
			} : function(a, b) {
				return c(f[a], f[b])
			});
	...
	Zg.layout.stack = function() {
		function a(h, i) {
			var j = h.map(function(c, d) {
				...
				l = c.call(a, k, i);
			j = Zg.permute(j, l), k = Zg.permute(k, l);
		...
		return a.values = function(c) {
			...
			return arguments.length ? (c = "function" == typeof b ? b : nj.get(b) || ef, a) : c
		}, a.offset = function(b) {
			return arguments.length ? (d = "function" == typeof b ? b : oj.get(b) || ff, a) : d
		}, a.x = function(b) {
	...
	Zg.layout.histogram = function() {
		function a(a, f) {
			...
			if (n > 0)
				for (f = -1; ++f < m;) h = j[f], h >= k[0] && h <= k[1] && (g = i[Zg.bisect(l, h, 1, n) - 1], g.y += o, g.push(a[f]));
			return i
		}
		var b = !0,
			c = Number,
		...
		function a(a, f) {
			...
			function i(a, b, d) {
				if (b) {
					for (var e, f = a, g = a, h = b, i = a.parent.children[0], j = f._tree.mod, k = g._tree.mod, l = h._tree.mod, m = i._tree.mod; h = pf(h), f = of(f), h && f;) i = of(i), g = pf(g), g._tree.ancestor = a, e = h._tree.prelim + l - f._tree.prelim - j + c(h, f), e > 0 && (wf(xf(h, a, d), a, e), j += e, k += e), l += h._tree.mod, j += f._tree.mod, m += i._tree.mod, k += g._tree.mod;
					h && !pf(g) && (g._tree.thread = h, g._tree.mod += l - k), f && !of(i) && (i._tree.thread = f, i._tree.mod += j - m, d = a)
				}
				return d
			}
		...
		function a(a, f) {
			...
			if (h.x = h.y = 0, uf(h, function(a) {
				a.r = +k(a.value)
			}), uf(h, Cf), d) {
				var l = d * (b ? 1 : Math.max(2 * h.r / i, 2 * h.r / j)) / 2;
				uf(h, function(a) {
					a.r += l
				}), uf(h, Cf), uf(h, function(a) {
					a.r -= l
				})
			}
			return Ff(h, i / 2, j / 2, b ? 1 : 1 / Math.max(2 * h.r / i, 2 * h.r / j)), g
		}
		var b, c = Zg.layout.hierarchy()
				.sort(yf),
			d = 0,
			e = [1, 1];
		...
		function a(a, f) {
			...
			uf(i, function(a) {
				var b = a.children;
				b && b.length ? (a.x = If(b), a.y = Hf(b)) : (a.x = g ? j += c(a, g) : 0, a.y = 0, g = a)
			});
			var k = Jf(i),
				l = Kf(i),
				m = k.x - c(k, l) / 2,
				n = l.x + c(l, k) / 2;
			return uf(i, e ? function(a) {
	...
	}, Zg.layout.treemap = function() {
		function a(a, b) {
			for (var c, d, e = -1, f = a.length; ++e < f;) d = (c = a[e])
				.value * (0 > b ? 0 : b), c.area = isNaN(d) || 0 >= d ? 0 : d
		}
		...
		function b(c) {
			...
			if (f && f.length) {
				...
				for (a(m, j.dx * j.dy / c.value), k.area = 0;
					(i = m.length) > 0;) k.push(g = m[i - 1]), k.area += g.area, "squarify" !== n || (h = d(k, p)) <= o ? (m.pop(), o = h) : (k.area -= k.pop()
					.area, e(k, p, j, !1), p = Math.min(j.dx, j.dy), k.length = k.area = 0, o = 1 / 0);
		...
		return f.size = function(a) {
			...
			function b(b) {
				...
				return null == c ? Lf(b) : Mf(b, "number" == typeof c ? [c, c, c, c] : c)
			}
			...
			var d;
			return l = null == (k = a) ? Lf : "function" == (d = typeof a) ? b : "number" === d ? (a = [a, a, a, a], c) : c, f
		}, f.round = function(a) {
		...
		logNormal: function() {
			var a = Zg.random.normal.apply(Zg, arguments);
			return function() {
				return Math.exp(a())
			}
		},
		bates: function(a) {
			var b = Zg.random.irwinHall(a);
			return function() {
				return b() / a
			}
		},
	...
	Zg.scale.linear = function() {
		return Tf([0, 1], [0, 1], qe, !1)
	};
	var qj = {
		s: 1,
		g: 1,
	...
	Zg.scale.log = function() {
		return _f(Zg.scale.linear()
	...
	Zg.scale.pow = function() {
		return ag(Zg.scale.linear(), 1, [0, 1])
	}, Zg.scale.sqrt = function() {
		return Zg.scale.pow()
			.exponent(.5)
	}, Zg.scale.ordinal = function() {
		return cg([], {
			t: "range",
			a: [
				[]
	...
	}, Zg.scale.category10 = function() {
		return Zg.scale.ordinal()
			.range(tj)
	}, Zg.scale.category20 = function() {
		return Zg.scale.ordinal()
			.range(uj)
	}, Zg.scale.category20b = function() {
		return Zg.scale.ordinal()
			.range(vj)
	}, Zg.scale.category20c = function() {
		return Zg.scale.ordinal()
			.range(wj)
	};
	var tj = [2062260, 16744206, 2924588, 14034728, 9725885, 9197131, 14907330, 8355711, 12369186, 1556175].map(rb),
		uj = [2062260, 11454440, 16744206, 16759672, 2924588, 10018698, 14034728, 16750742, 9725885, 12955861, 9197131, 12885140, 14907330, 16234194, 8355711, 13092807, 12369186, 14408589, 1556175, 10410725].map(rb),
		vj = [3750777, 5395619, 7040719, 10264286, 6519097, 9216594, 11915115, 13556636, 9202993, 12426809, 15186514, 15190932, 8666169, 11356490, 14049643, 15177372, 8077683, 10834324, 13528509, 14589654].map(rb),
		wj = [3244733, 7057110, 10406625, 13032431, 15095053, 16616764, 16625259, 16634018, 3253076, 7652470, 10607003, 13101504, 7695281, 10394312, 12369372, 14342891, 6513507, 9868950, 12434877, 14277081].map(rb);
	Zg.scale.quantile = function() {
		return dg([], [])
	}, Zg.scale.quantize = function() {
		return eg(0, 1, [0, 1])
	}, Zg.scale.threshold = function() {
		return fg([.5], [0, 1])
	}, Zg.scale.identity = function() {
		return gg([0, 1])
	}, Zg.svg = {}, Zg.svg.arc = function() {
		function a() {
			var a = b.apply(this, arguments),
				f = c.apply(this, arguments),
				g = d.apply(this, arguments) + xj,
				h = e.apply(this, arguments) + xj,
				...
				m = Math.cos(h),
				n = Math.sin(h);
			return i >= yj ? a ? "M0," + f + "A" + f + "," + f + " 0 1,1 0," + -f + "A" + f + "," + f + " 0 1,1 0," + f + "M0," + a + "A" + a + "," + a + " 0 1,0 0," + -a + "A" + a + "," + a + " 0 1,0 0," + a + "Z" : "M0," + f + "A" + f + "," + f + " 0 1,1 0," + -f + "A" + f + "," + f + " 0 1,1 0," + f + "Z" : a ? "M" + f * k + "," + f * l + "A" + f + "," + f + " 0 " + j + ",1 " + f * m + "," + f * n + "L" + a * m + "," + a * n + "A" + a + "," + a + " 0 " + j + ",0 " + a * k + "," + a * l + "Z" : "M" + f * k + "," + f * l + "A" + f + "," + f + " 0 " + j + ",1 " + f * m + "," + f * n + "L0,0Z"
		}
		var b = hg,
			c = ig,
			d = jg,
		...
		return a.innerRadius = function(c) {
			...
			var a = (b.apply(this, arguments) + c.apply(this, arguments)) / 2,
				f = (d.apply(this, arguments) + e.apply(this, arguments)) / 2 + xj;
			return [Math.cos(f) * a, Math.sin(f) * a]
		}, a
	};
	var xj = -Eh,
		yj = Dh - Fh;
	Zg.svg.line = function() {
		return lg(Bb)
	};
	var zj = Zg.map({
		linear: mg,
	...
	zj.forEach(function(a, b) {
		b.key = a, b.closed = /-closed$/.test(a)
	});
	var Aj = [0, 2 / 3, 1 / 3, 0],
		Bj = [0, 1 / 3, 2 / 3, 0],
		Cj = [0, 1 / 6, 2 / 3, 1 / 6];
	Zg.svg.line.radial = function() {
		var a = lg(Gg);
		return a.radius = a.x, delete a.x, a.angle = a.y, delete a.y, a
	}, pg.reverse = qg, qg.reverse = pg, Zg.svg.area = function() {
		return Hg(Bb)
	...
	}, Zg.svg.diagonal.radial = function() {
		var a = Zg.svg.diagonal(),
			b = Jg,
			c = a.projection;
		return a.projection = function(a) {
			return arguments.length ? c(Kg(b = a)) : b
		}, a
	}, Zg.svg.symbol = function() {
		function a(a, d) {
			return (Dj.get(b.call(this, a, d)) || Ng)(c.call(this, a, d))
		}
		var b = Mg,
			c = Lg;
	...
	Zg.svg.symbolTypes = Dj.keys();
	var Ej, Fj, Gj = Math.sqrt(3),
		Hj = Math.tan(30 * Hh),
		Ij = [],
		Jj = 0;
	Ij.call = vh.call, Ij.empty = vh.empty, Ij.node = vh.node, Ij.size = vh.size, Zg.transition = function(a) {
		return arguments.length ? Ej ? a.transition() : a : yh.transition()
	}, Zg.transition.prototype = Ij, Ij.select = function(a) {
		var b, c, d, e = this.id,
			f = [];
		a = w(a);
		for (var g = -1, h = this.length; ++g < h;) {
			f.push(b = []);
			for (var i = this[g], j = -1, k = i.length; ++j < k;)(d = i[j]) && (c = a.call(d, d.__data__, j, g)) ? ("__data__" in d && (c.__data__ = d.__data__), Rg(c, j, e, d.__transition__[e]), b.push(c)) : b.push(null)
		}
		return Og(f, e)
	}, Ij.selectAll = function(a) {
		...
		for (var i = -1, j = this.length; ++i < j;)
			for (var k = this[i], l = -1, m = k.length; ++l < m;)
				if (d = k[l]) {
					...
					for (var n = -1, o = c.length; ++n < o;)(e = c[n]) && Rg(e, n, g, f), b.push(e)
				}
		return Og(h, g)
	}, Ij.filter = function(a) {
		var b, c, d, e = [];
		"function" != typeof a && (a = I(a));
		for (var f = 0, g = this.length; g > f; f++) {
			e.push(b = []);
		...
		var g = "transform" == a ? Ne : qe,
			h = Zg.ns.qualify(a);
		return Pg(this, "attr." + a, b, h.local ? f : e)
	}, Ij.attrTween = function(a, b) {
		function c(a, c) {
		...
		var e = Zg.ns.qualify(a);
		return this.tween("attr." + a, e.local ? d : c)
	}, Ij.style = function(a, b, c) {
		function d() {
			this.style.removeProperty(a)
		}
		...
		function e(b) {
			return null == b ? d : (b += "", function() {
				var d, e = ch.getComputedStyle(this, null)
						.getPropertyValue(a);
		...
		return Pg(this, "style." + a, b, e)
	}, Ij.styleTween = function(a, b, c) {
		function d(d, e) {
			var f = b.call(this, d, e, ch.getComputedStyle(this, null)
				.getPropertyValue(a));
			return f && function(b) {
		...
		return arguments.length < 1 ? this.node()
			.__transition__[b].ease : ("function" != typeof a && (a = Zg.ease.apply(Zg, arguments)), K(this, function(c) {
				c.__transition__[b].ease = a
			}))
	}, Ij.delay = function(a) {
		var b = this.id;
		return arguments.length < 1 ? this.node()
			.__transition__[b].delay : K(this, "function" == typeof a ? function(c, d, e) {
				c.__transition__[b].delay = +a.call(c, c.__data__, d, e)
			} : (a = +a, function(c) {
				c.__transition__[b].delay = a
			}))
	}, Ij.duration = function(a) {
		var b = this.id;
		return arguments.length < 1 ? this.node()
			.__transition__[b].duration : K(this, "function" == typeof a ? function(c, d, e) {
				c.__transition__[b].duration = Math.max(1, a.call(c, c.__data__, d, e))
			} : (a = Math.max(1, a), function(c) {
				c.__transition__[b].duration = a
			}))
	}, Ij.each = function(a, b) {
		var c = this.id;
		if (arguments.length < 2) {
			var d = Fj,
				e = Ej;
			Ej = c, K(this, function(b, d, e) {
				Fj = b.__transition__[c], a.call(b, b.__data__, d, e)
			}), Fj = d, Ej = e
		} else K(this, function(d) {
			var e = d.__transition__[c];
			(e.event || (e.event = Zg.dispatch("start", "end")))
				.on(a, b)
		});
		return this
	}, Ij.transition = function() {
		for (var a, b, c, d, e = this.id, f = ++Jj, g = [], h = 0, i = this.length; i > h; h++) {
			g.push(a = []);
			for (var b = this[h], j = 0, k = b.length; k > j; j++)(c = b[j]) && (d = Object.create(c.__transition__[e]), d.delay += d.duration, Rg(c, j, f, d)), a.push(c)
		}
		return Og(g, f)
	}, Zg.svg.axis = function() {
		function a(a) {
			a.each(function() {
				var a, j = Zg.select(this),
					k = this.__chart__ || c,
					...
					p = o.enter()
						...
						.attr("class", "tick")
						.style("opacity", Fh),
					q = Zg.transition(o.exit())
						.style("opacity", Fh)
						.remove(),
					r = Zg.transition(o.order())
						.style("opacity", 1),
					s = Of(l),
					t = j.selectAll(".domain")
						.data([0]),
					u = (t.enter()
						.append("path")
						.attr("class", "domain"), Zg.transition(t));
				...
				switch (d) {
					case "bottom":
						a = Sg, v.attr("y2", e), y.attr("y", Math.max(e, 0) + g), w.attr("x2", 0)
							.attr("y2", e), z.attr("x", 0)
							.attr("y", Math.max(e, 0) + g), x.attr("dy", ".71em")
							.style("text-anchor", "middle"), u.attr("d", "M" + s[0] + "," + f + "V0H" + s[1] + "V" + f);
						break;
					case "top":
						a = Sg, v.attr("y2", -e), y.attr("y", -(Math.max(e, 0) + g)), w.attr("x2", 0)
							.attr("y2", -e), z.attr("x", 0)
							.attr("y", -(Math.max(e, 0) + g)), x.attr("dy", "0em")
							.style("text-anchor", "middle"), u.attr("d", "M" + s[0] + "," + -f + "V0H" + s[1] + "V" + -f);
						break;
					case "left":
						a = Tg, v.attr("x2", -e), y.attr("x", -(Math.max(e, 0) + g)), w.attr("x2", -e)
							.attr("y2", 0), z.attr("x", -(Math.max(e, 0) + g))
							.attr("y", 0), x.attr("dy", ".32em")
							.style("text-anchor", "end"), u.attr("d", "M" + -f + "," + s[0] + "H0V" + s[1] + "H" + -f);
						break;
					case "right":
						a = Tg, v.attr("x2", e), y.attr("x", Math.max(e, 0) + g), w.attr("x2", e)
							.attr("y2", 0), z.attr("x", Math.max(e, 0) + g)
							.attr("y", 0), x.attr("dy", ".32em")
							.style("text-anchor", "start"), u.attr("d", "M" + f + "," + s[0] + "H0V" + s[1] + "H" + f)
				}
				if (l.rangeBand) {
					var A = l,
						B = A.rangeBand() / 2;
		...
		return a.scale = function(b) {
			...
			return arguments.length ? (d = b in Lj ? b + "" : Kj, a) : d
		}, a.ticks = function() {
	...
	Zg.svg.brush = function() {
		function a(f) {
			f.each(function() {
				var f = Zg.select(this)
					.style("pointer-events", "all")
					.style("-webkit-tap-highlight-color", "rgba(0,0,0,0)")
					.on("mousedown.brush", e)
					.on("touchstart.brush", e),
					g = f.selectAll(".background")
						.data([0]);
				g.enter()
					.append("rect")
					.attr("class", "background")
					.style("visibility", "hidden")
					.style("cursor", "crosshair"), f.selectAll(".extent")
					.data([0])
					.enter()
					.append("rect")
					.attr("class", "extent")
					.style("cursor", "move");
				var h = f.selectAll(".resize")
					.data(o, Bb);
				h.exit()
					.remove(), h.enter()
					.append("g")
					...
					.attr("width", 6)
					.attr("height", 6)
					.style("visibility", "hidden"), h.style("display", a.empty() ? "none" : null);
				var k, l = Zg.transition(f),
					m = Zg.transition(g);
				i && (k = Of(i), m.attr("x", k[0])
					.attr("width", k[1] - k[0]), c(l)), j && (k = Of(j), m.attr("y", k[0])
					.attr("height", k[1] - k[0]), d(l)), b(l)
			})
		}
		...
		function c(a) {
			a.select(".extent")
				.attr("x", k[0]), a.selectAll(".extent,.n>rect,.s>rect")
				.attr("width", k[1] - k[0])
		}

		function d(a) {
			a.select(".extent")
				.attr("y", l[0]), a.selectAll(".extent,.e>rect,.w>rect")
				.attr("height", l[1] - l[0])
		}

		function e() {
			function e() {
				32 == Zg.event.keyCode && (C || (t = null, E[0] -= k[1], E[1] -= l[1], C = 2), s())
			}

			function o() {
				32 == Zg.event.keyCode && 2 == C && (E[0] += k[1], E[1] += l[1], C = 0, s())
			}

			function p() {
				var a = Zg.mouse(v),
					e = !1;
				u && (a[0] += u[0], a[1] += u[1]), C || (Zg.event.altKey ? (t || (t = [(k[0] + k[1]) / 2, (l[0] + l[1]) / 2]), E[0] = k[+(a[0] < t[0])], E[1] = l[+(a[1] < t[1])]) : t = null), A && q(a, i, 0) && (c(y), e = !0), B && q(a, j, 1) && (d(y), e = !0), e && (b(y), x({
					type: "brush",
					mode: C ? "move" : "resize"
				}))
			}
			...
			function r() {
				p(), y.style("pointer-events", "all")
					.selectAll(".resize")
					.style("display", a.empty() ? "none" : null), Zg.select("body")
					.style("cursor", null), F.on("mousemove.brush", null)
					.on("mouseup.brush", null)
					.on("touchmove.brush", null)
					.on("touchend.brush", null)
					.on("keydown.brush", null)
					.on("keyup.brush", null), D(), x({
						type: "brushend"
					})
			}
			var t, u, v = this,
				...
				F = Zg.select(ch)
					.on("keydown.brush", e)
					.on("keyup.brush", o);
			if (Zg.event.changedTouches ? F.on("touchmove.brush", p)
				.on("touchend.brush", r) : F.on("mousemove.brush", p)
				.on("mouseup.brush", r), y.interrupt()
				.selectAll("*")
				.interrupt(), C) E[0] = k[0] - E[0], E[1] = l[0] - E[1];
			else if (z) {
				var G = +/w$/.test(z),
					H = +/^n/.test(z);
				u = [k[1 - G] - E[0], l[1 - H] - E[1]], E[0] = k[G], E[1] = l[H]
			} else Zg.event.altKey && (t = E.slice());
			y.style("pointer-events", "none")
				.selectAll(".resize")
				.style("display", null), Zg.select("body")
				.style("cursor", w.style("cursor")), x({
					type: "brushstart"
				}), p()
		}
		...
		return a.event = function(a) {
			a.each(function() {
				...
				this.__chart__ = b, Ej ? Zg.select(this)
					.transition()
			...
			return arguments.length ? (i = b, o = Nj[!i << 1 | !j], a) : i
		}, a.y = function(b) {
			return arguments.length ? (j = b, o = Nj[!i << 1 | !j], a) : j
		}, a.clamp = function(b) {
	...
	var Mj = {
		...
		Oj = fi.format = li.timeFormat,
		Pj = Oj.utc,
		Qj = Pj("%Y-%m-%dT%H:%M:%S.%LZ");
	Oj.iso = Date.prototype.toISOString && +new Date("2000-01-01T00:00:00.000Z") ? Ug : Qj, Ug.parse = function(a) {
		var b = new Date(a);
		return isNaN(b) ? null : b
	}, Ug.toString = Qj.toString, fi.second = Nb(function(a) {
		return new gi(1e3 * Math.floor(a / 1e3))
	}, function(a, b) {
		a.setTime(a.getTime() + 1e3 * Math.floor(b))
	}, function(a) {
		return a.getSeconds()
	}), fi.seconds = fi.second.range, fi.seconds.utc = fi.second.utc.range, fi.minute = Nb(function(a) {
		return new gi(6e4 * Math.floor(a / 6e4))
	}, function(a, b) {
		a.setTime(a.getTime() + 6e4 * Math.floor(b))
	}, function(a) {
		return a.getMinutes()
	}), fi.minutes = fi.minute.range, fi.minutes.utc = fi.minute.utc.range, fi.hour = Nb(function(a) {
		var b = a.getTimezoneOffset() / 60;
		return new gi(36e5 * (Math.floor(a / 36e5 - b) + b))
	}, function(a, b) {
		a.setTime(a.getTime() + 36e5 * Math.floor(b))
	}, function(a) {
		return a.getHours()
	}), fi.hours = fi.hour.range, fi.hours.utc = fi.hour.utc.range, fi.month = Nb(function(a) {
		return a = fi.day(a), a.setDate(1), a
	}, function(a, b) {
		a.setMonth(a.getMonth() + b)
	}, function(a) {
		return a.getMonth()
	}), fi.months = fi.month.range, fi.months.utc = fi.month.utc.range;
	var Rj = [1e3, 5e3, 15e3, 3e4, 6e4, 3e5, 9e5, 18e5, 36e5, 108e5, 216e5, 432e5, 864e5, 1728e5, 6048e5, 2592e6, 7776e6, 31536e6],
		Sj = [
			[fi.second, 1],
			[fi.second, 5],
			[fi.second, 15],
		...
		Uj = {
			range: function(a, b, c) {
				return Zg.range(Math.ceil(a / c) * c, +b, c)
					.map(Wg)
			},
			floor: Bb,
			ceil: Bb
		};
	Sj.year = fi.year, fi.scale = function() {
		return Vg(Zg.scale.linear(), Sj, Tj)
	};
	var Vj = Sj.map(function(a) {
		return [a[0].utc, a[1]]
	}),
		Wj = Pj.multi([
			[".%L",
	...
	Vj.year = fi.year.utc, fi.scale.utc = function() {
		return Vg(Zg.scale.linear(), Vj, Wj)
	}, Zg.text = Cb(function(a) {
		return a.responseText
	}), Zg.json = function(a, b) {
		return Db(a, "application/json", Xg, b)
	}, Zg.html = function(a, b) {
		return Db(a, "text/html", Yg, b)
	}, Zg.xml = Cb(function(a) {
		return a.responseXML
	}), "function" == typeof define && define.amd ? define(Zg) : "object" == typeof module && module.exports ? module.exports = Zg : this.d3 = Zg
}(), ! function() {
	var a = {}, b = null,
		c = !0,
		d = !1;
	...
	if (!d) {
		i = new Audio;
		var j = {
			mp3: !! i.canPlayType("audio/mpeg;")
				.replace(/^no$/, ""),
			opus: !! i.canPlayType('audio/ogg; codecs="opus"')
				.replace(/^no$/, ""),
			ogg: !! i.canPlayType('audio/ogg; codecs="vorbis"')
				.replace(/^no$/, ""),
			wav: !! i.canPlayType('audio/wav; codecs="1"')
				.replace(/^no$/, ""),
			m4a: !! (i.canPlayType("audio/x-m4a;") || i.canPlayType("audio/aac;"))
				.replace(/^no$/, ""),
			mp4: !! (i.canPlayType("audio/x-mp4;") || i.canPlayType("audio/aac;"))
				.replace(/^no$/, ""),
			weba: !! i.canPlayType('audio/webm; codecs="vorbis"')
				.replace(/^no$/, "")
		}
	}
	var k = function(a) {
	...
	if (k.prototype = {
		load: function() {
			...
			for (var e = 0; e < b._urls.length; e++) {
				...
				if (b._format) f = b._format;
					...
					if (g = b._urls[e].toLowerCase()
						.split("?")[0], f = g.match(/.+\.([^?]+)(\?|$)/), f = f && f.length >= 2 ? f : g.match(/data\:audio\/([^?]+);/), !f) return void b.on("loaderror");
					f = f[1]
				} if (j[f]) {
					c = b._urls[e];
					break
			...
			if (b._src = c, b._webAudio) l(b, c);
				...
				var k = function() {
					b._duration = Math.ceil(10 * i.duration) / 10, 0 === Object.getOwnPropertyNames(b._sprite)
						.length && (b._sprite = {
				...
				if (function() {
					...
					f = setTimeout(function() {
						!d._webAudio && j && d.stop(b.id, b.timer)
							.play(a, b.id), d._webAudio && !j && (d._nodeById(b.id)
								.paused = !0, d._nodeById(b.id)
								._pos = 0), d._webAudio || j || d.stop(b.id, b.timer), d.on("end", k)
					}, 1e3 * i), d._onendTimer.push(f), b.timer = d._onendTimer[d._onendTimer.length - 1]
				}(), d._webAudio) {
					var l = d._sprite[a][0] / 1e3,
						m = d._sprite[a][1] / 1e3;
					e.id = k, e.paused = !1, n(d, [j, l, m], k), d._playStart = b.currentTime, e.gain.value = d._volume, void 0 === e.bufferSource.start ? e.bufferSource.noteGrainOn(0, g, i) : e.bufferSource.start(0, g, i)
				} else {
		...
		_setupAudioNode: function() {
			...
			return c[d] = void 0 === b.createGain ? b.createGainNode() : b.createGain(), c[d].gain.value = a._volume, c[d].paused = !0, c[d]._pos = 0, c[d].readyState = 4, c[d].connect(f), c[d].panner = b.createPanner(), c[d].panner.setPosition(a._pos3d[0], a._pos3d[1], a._pos3d[2]), c[d].panner.connect(c[d]), c[d]
		},
		on: function(a, b) {
			var c = this,
				d = c["_on" + a];
		...
		off: function(a, b) {
			for (var c = this, d = c["_on" + a], e = "" + b, f = 0; f < d.length; f++)
				if (e === "" + d[f]) {
					d.splice(f, 1);
					break
				}
		...
		if (d in a) c._duration = a[d].duration, m(c);
			...
			a._duration = b ? b.duration : a._duration, 0 === Object.getOwnPropertyNames(a._sprite)
				.length && (a._sprite = {
	...
	function(a, b) {
		a.user = b, a.log = function() {}
	}
]), app.controller("navigation", ["$scope",
	function(a) {
		a.show_navigation = !1, a["switch"] = function() {
			a.show_navigation = !a.show_navigation
		}
	}
]), app.controller("home", ["$scope", "$http", "user",
	function(a, b, c) {
		a.recommendations = [], c.refresh(), a.user = c, b.get("/api/recom")
			.success(function(b) {
				a.recommendations = b
			}), a.scores = [], a.current_score = "", a.streak_status = {}, a.score_lookBehind = 30, a.score_loaded = !1, a.refreshChart = function(c) {
				b.get("/api/scoreboard?amount=" + c)
					.success(function(c) {
						a.scores = c, a.current_score = c[0].me, b.get("/api/streak_status")
							.success(function(b) {
								a.streak_status = b, a.score_loaded = !0
							})
					})
		}, a.refreshChart(a.score_lookBehind), a.$watch("score_lookBehind", function(b) {
			a.refreshChart(b)
		})
	}
]), app.controller("exercise_list", ["$scope", "$http", "$routeParams",
	function(a, b, c) {
		console.log(c), a.exercise_list_loaded = !1, a.exercises = [], a.filter = {
			muscle_part: "all"
		}, a.sort = "days_since_last_exercise", a.muscle_parts = [{
			id: "all",
			name: "any"
		}], a.filterExercises = function(b) {
			var c = a.filter.muscle_part;
			return "all" == c ? !0 : c == b.muscle_part_id ? !0 : !1
		}, a.getMuscleName = function() {
			for (var b in a.muscle_parts)
				if (a.muscle_parts[b].id == a.filter.muscle_part) return a.muscle_parts[b].name
		}, a.$watch("filter.muscle_part", function() {}), b.get("/api/exercises")
			.success(function(b) {
				a.exercises = b;
				for (var d in b) {
					var e = {
						id: b[d].muscle_part_id,
						name: b[d].type_name
					}, f = !1;
					for (var g in a.muscle_parts) a.muscle_parts[g].id == e.id && (f = !0);
					f || a.muscle_parts.push(e), b[d].days_since_last_exercise = parseInt(b[d].days_since_last_exercise)
				}
				if (void 0 != c.muscle_type_name && "all" != c.muscle_type_name)
					for (var d in a.muscle_parts) a.muscle_parts[d].name == c.muscle_type_name && (a.filter.muscle_part = a.muscle_parts[d].id);
				a.exercise_list_loaded = !0
			})
	}
]), app.controller("new_exercise", ["$scope", "$http",
	function(a, b) {
		a.exercise_list_loaded, a.muscle_parts = [], a.exercise_data = {
			name: "",
			muscle_part_id: "",
			...
			{
				var c = a.exercise_data;
				({
					name: c.name
				})
			}
			c.use_custom_muscle ? b.post("/api/muscleParts", {
				name: c.muscle_part_name_custom
			})
				.success(function(b) {
					var c = b.id;
					a.postExercise(c)
				}) : a.postExercise(c.muscle_part_id)
		}, a.postExercise = function(c) {
			var d = a.exercise_data,
				e = {
					name: d.name,
					muscle_part_id: c
				};
			b.post("/api/exercises", e)
				.success(function(b) {
					var c = b.id;
					a.createSets(c)
				})
		}, a.createSets = function(c) {
			var d = a.exercise_data.template,
				e = [];
			switch (d.type) {
				case "traditional":
					for (var f = 1; f <= d.params.traditional.set_amount; f++) {
						var g = {
							name: "set #" + f,
							exercise_id: c,
							orderL: f,
				...
				case "outside":
					...
					break;
				case "fancy":
					var i = d.params.fancy.rows;
					for (var f in i) e.push({
						name: i[f].name,
						orderL: f + 1,
						unit: i[f].unit,
						exercise_id: c
			...
			console.log(e);
			var j = 0;
			for (var f in e) b.post("/api/setTemplates", e[f])
				.success(function() {
					j++, j == e.length && a.finish_saving(c)
				})
		}, a.finish_saving = function(a) {
			document.location.hash = "/exercise/" + a
		}, a.status = {}, a.add_fancy_row = function() {
			a.exercise_data.template.params.fancy.rows.push({
				name: "",
				unit: ""
			})
		}, a.remove_fancy_row = function(b) {
			a.exercise_data.template.params.fancy.rows.splice(b, 1)
		}, a.validateTemplate = function() {
			var b = a.exercise_data,
				c = b.template;
			switch (c.type) {
				case "traditional":
					return parseInt(c.params.traditional.set_amount) > 0 ? {
						status: "ok"
					} : {
						status: "error"
					};
				case "outside":
					var d = !0;
					for (var e in c.params.outside) "boolean" != typeof c.params.outside[e] && (d = !1);
					return d ? {
						status: "ok"
					} : {
						status: "error"
				...
				case "fancy":
					var f = c.params.fancy.rows,
						d = !0;
					for (var e in f)(0 == f[e].name.length || 0 == f[e].unit.length) && (d = !1);
					return d ? {
						status: "ok"
					} : {
						status: "error"
		...
		}, a.validateName = function(b) {
			var c = "ok",
				d = "ok!";
			if ("" == b) return {};
			b.length < 4 && b.length > 0 && (c = "error", d = "too short!");
			for (var e in a.exercises) a.exercises[e].name.toLowerCase() == b.toLowerCase() && (c = "error", d = "already exists!");
			return {
				status: c,
				message: d
			}
		}, a.getStatus = function() {
			var b = "error" != a.validateName(a.exercise_data.name)
				.status && a.exercise_data.name.length > 4,
				c = "" != a.exercise_data.muscle_part_id || a.exercise_data.use_custom_muscle && "" != a.exercise_data.muscle_part_name_custom,
				d = "error" != a.validateTemplate()
					.status;
			return {
				name_ok: b,
				type_ok: c,
			...
			.success(function(b) {
				...
				for (var c in b) {
					var d = {
						id: b[c].muscle_part_id,
						name: b[c].type_name
					}, e = !1;
					for (var f in a.muscle_parts) a.muscle_parts[f].id == d.id && (e = !0);
					e || a.muscle_parts.push(d)
				}
				a.exercise_list_loaded = !0
			})
	}
	...
	function(a, b, c) {
		a.data_loaded = !1, a.log_loaded = !1, a.round = Math.round, b.get("/api/exercises/" + c.id)
			.success(function(b) {
				a.data_loaded = !0, a.exercise = b, a.exercise.show_in_recom = 0 == parseInt(a.exercise.paused)
			}), b.get("/api/exercises/" + c.id + "/log?count=10")
			.success(function(b) {
				a.log_loaded = !0, a.log = b
			}), a.adjust_paused = function() {
				a.exercise.paused = a.exercise.show_in_recom ? 0 : 1, b.post("/api/exercises/" + c.id, a.exercise)
		}, a.negatePaused = function() {
			a.exercise.show_in_recom = !a.exercise.show_in_recom, a.adjust_paused()
		}
	}
]), app.controller("exercise_go", ["$scope", "$http", "$routeParams", "music_player", "$rootScope", "metronome", "user", "notifSound",
	function(a, b, c, d, e, f, g, h) {
		function i() {
			-1 == document.location.hash.indexOf("/go") && (a.music_fadeOut(500), f.pause(), console.log("fadingOut"))
		}
		a.exercise_loaded = !1;
		var j = new Date;
		a.start_time = j.getTime(), a.exercise, a.template, a.metronome_active = !1, a.music_paused = !1, a.current_set_no = 0, a.current_set_template = {}, a.last_result = {}, a.timer = g.timer, a.results = [], a.mode = "set", a.time_waited = 0, a.time_waited_checkpoint, a.startTimer = function(b) {
			a.mode = "timer", a.timer = b;
			var c = new Date,
				d = c.getTime();
			a.time_waited_checkpoint = d, a.timerTick(d, b)
		}, a.timerTick = function(b, c) {
			var d = new Date,
				e = d.getTime(),
				f = Math.floor((e - b) / 1e3);
			a.time_waited += e - a.time_waited_checkpoint, a.time_waited_checkpoint = e, a.timer = c - f, c > f && "timer" == a.mode && setTimeout(function() {
				a.timerTick(b, c), a.$apply()
			}, 1e3), f >= c && (h.play(), a.nextSet())
		}, a.next = function() {
			a.music_fadeOut(100), f.pause(), a.current_set_no == a.exercise.setTemplates.length ? a.finish() : a.startTimer(g.timer)
		}, a.metronome = {
			play: function() {
				f.play()
			},
		...
		}, a.$watch("metronome_active", function(b) {
			b ? (a.metronome.play(), a.setMusicVolume(5)) : (a.metronome.pause(), a.setMusicVolume(100))
		}), a.setMusicVolume = function(a) {
			d.setVolume(a)
		}, a.$watch("music_paused", function(b) {
			b ? a.music_pause() : a.music_play()
		}), window.onhashchange = i, window.onclick = i, a.music_fadeOut = function(b) {
			d.fadeOut(b), setTimeout(function() {
				a.music_pause()
			}, b)
		}, a.nextSet = function() {
			a.current_set_no < a.exercise.setTemplates.length ? (a.mode = "set", a.music_play(), a.current_set_template = a.template[a.current_set_no], a.current_set_no += 1) : a.finish()
		}, a.finish = function() {
			a.mode = "finish";
			var b = new Date;
			a.end_time = b.getTime()
		}, a.music_pause = function() {
			d.pause(), a.music_paused = !0
		}, a.music_play = function() {
			d.play(), a.music_paused = !1
		}, a.music_reset = function() {
			d.reset()
		}, a.saving = !1, a.saved = !1, a.save = function() {
			console.log("saving");
			var c = {
				exercise_id: a.exercise.id,
				result: a.results,
				type: "regular",
				begin_time: Math.round(a.start_time / 1e3),
				duration_s: Math.floor((a.end_time - a.start_time - a.time_waited) / 1e3)
			};
			a.saving = !0, b.post("/api/log/", c)
				.success(function() {
					a.saving = !1, a.saved = !0
				})
		}, b.get("/api/exercises/" + c.id)
			.success(function(d) {
				a.exercise = d, a.template = d.setTemplates;
				var e = 0;
				for (var f in a.template) e++;
				a.current_set_template = d.setTemplates[0], a.template.length = e, b.get("/api/exercises/" + c.id + "/log?count=1")
					.success(function(b) {
						a.last_result = b[0], a.exercise_loaded = !0, a.music_reset(), a.nextSet();
						for (var c = 0; e > c; c++) a.results[c] = a.exercise.recommendations[c]
					})
			})
	}
]), app.controller("history", ["$scope", "$http",
	function(a, b) {
		a.history = [], a.history_loaded = !1, b.get("/api/points?count=100")
			.success(function(b) {
				a.history = b, a.history_loaded = !0
			})
	}
]), app.controller("exercise_log", ["$scope", "$http", "$routeParams",
	function(a, b, c) {
		a.loaded = !1, a.exercises = [], a.results = [], a.type = "regular", a.types = [{
			id: "regular",
			name: "preset routine"
		}, {
			id: "custom",
			name: "custom"
		}], a.saved = !1, b.get("/api/exercises")
			.success(function(d) {
				a.exercises = d;
				var e = c.id;
				for (var f in d) d[f].id == e && (a.exercise = d[f]);
				b.get("/api/muscleParts")
					.success(function(b) {
						a.loaded = !0, a.muscle_parts = b
					})
			}), a.save = function() {
				var c = Math.round(Date.parse(a.begin_time) / 1e3),
					d = a.exercise.id,
					e = a.results,
					f = a.duration_s,
					g = {
						...
						result: e,
						duration_s: f,
						muscle_part_id: a.muscle_part_id,
						name: a.custom_name
					};
				g.result = "regular" == a.type ? e : a.custom_result, b.post("/api/log", g)
					.success(function(b) {
						a.saved = !0, document.location.hash = "/logs/" + JSON.parse(b)
					})
		}
	}
]), app.controller("log", ["$scope", "$http", "$routeParams",
	function(a, b, c) {
		a.log = {}, a.exercise = {}, a.loaded = !1, b.get("/api/log/" + c.logId)
			.success(function(c) {
				a.log = c, "regular" == c.type ? b.get("/api/exercises/" + c.exercise_id)
					.success(function(b) {
						a.exercise = b, a.loaded = !0
					}) : a.loaded = !0
			})
	}
	...
	return {
		...
		controller: function(a, b, c) {
			var d = a.data;
			console.log(d), a.$watch("data", function(b) {
				a.generate(b)
			}), a.generate = function(d) {
				console.log("generate begin"), console.log(d);
				var e = -1 / 0,
					f = 1 / 0;
				for (var g in d) d[g] = parseFloat(d[g]), d[g] > e && (e = d[g]), d[g] < f && (f = d[g], console.log("new min: ", f));
				if (void 0 == c.width) var h = 460;
				else var h = c.width; if (void 0 == c.height) var i = 180;
				else var i = c.height;
				var j = "absolute";
				1 == a.tiny && (h = 100, i = 20, j = "relative");
				var k = d3.select(b[0])
					.append("svg:svg")
					.attr("width", "100%")
					.attr("height", "100%")
					.attr("viewBox", "0 0 " + h + " " + i)
					.attr("preserveAspectRatio", "none")
					.attr("style", "width: 100%;height: 100%;display: block;position:" + j + ";top: 0px;left: 0px;");
				if (console.log(f, e), "true" == c.zero) var l = 0;
				else var l = f;
		...
		controller: function(a, b) {
			a.$watch("data", function(b) {
				...
				var c = {
					...
					bottom: 1,
					left: 0
				}, d = 700 - c.left - c.right,
					e = 284 - c.top - c.bottom,
					...
					m = d3.select(b[0])
						...
						.attr("viewBox", "0 0 " + d + " " + e)
						.append("g")
						.attr("transform", "translate(" + c.left + "," + c.top + ")");
				i.domain(d3.keys(a[0])
					.filter(function(a) {
						return "date" !== a
					}));
				var n = [];
				for (var o in a[0]) "date" != o && n.push(o);
				...
				g.domain(d3.extent(a, function(a) {
					return a.date
				})), h.domain([d3.min(p, function(a) {
					return d3.min(a.values, function(a) {
						return a.temperature
					})
				}), d3.max(p, function(a) {
					return d3.max(a.values, function(a) {
						return a.temperature
					})
				})]), m.append("g")
					.attr("class", "x axis")
				...
				var r = 80,
					...
					u = t.append("rect")
						.attr("width", r)
						.attr("height", 15 * n.length)
						.attr("style", "fill:rgba(255,255,255,0.7)");
				for (var o in n) t.append("rect")
					.attr("width", 10)
					.attr("height", 10)
					.attr("transform", "translate(" + s + ", " + 15 * o + ")")
					.attr("style", "fill:" + i(n[o])), t.append("text")
					.text(n[o])
					.attr("transform", "translate(18, " + (15 * o + 10) + ")");
				var v = t[0][0].getBoundingClientRect()
					.width,
					w = t[0][0].getBoundingClientRect()
						.height;
				u.attr("width", v), t.attr("transform", "translate(" + (d - v - 40) + ", " + (e - w) + ")")
			}
		}
	}
	...
	return {
		...
		template: "<div class='card' style='position:relative; text-align:center'><span style='align-self:flex-start; z-index:2'><span ng-show='recom.type!=\"most_neglected\"'>Recommended</span><span ng-show='recom.type==\"most_neglected\"'>Most neglected</span> exercise:</span><span style='font-size:2.8rem; z-index:2'><a href='#/exercise/{{recom.exercise.id}}'>{{recom.exercise.name}}</a></span><span style='margin-top: -4px;padding-bottom: 8px; z-index:2'>last exercised: {{recom.exercise.days_since_last_exercise}} days ago</span><a class='button' style='z-index:2' href='#/exercise/{{recom.exercise.id}}/go'>exercise!</a><span style='margin-bottom: -8px; z-index:2;color:gray;font-weight:100'>{{recom.exercise.estimated_duration/60 | number: 0}}min</span><a class='secondary' href='#/exercises/{{recom.exercise.muscle_part_name}}' style='align-self:flex-end; z-index:2; transition-delay:100ms'>other exercises for {{recom.exercise.muscle_part_name}}</a><sparkline class='secondary' data='recom.exercise.results' style='width:100%; height:100%; position:absolute; top:0px; left:0px;'></sparkline></div>",
...
app.service("user", ["btrResource", "$http",
	...
	var a = new buzz.sound("/web/sounds/metronome", {
		formats: ["mp3"],
		preload: !0,
		loop: !0
	});
	...
	var a = new buzz.sound("/web/sounds/notif", {
		formats: ["mp3"],
		preload: !0,
		loop: !1
	});
	...
	var a = !1,
		b = new buzz.sound("/web/sounds/getInShapeLoop", {
			formats: ["mp3"],
			preload: !0,
			loop: !0
		});
	window.test_h = b, window.test_s = this, this.reset = function() {
		b.setPercent(0)
	}, this.fadeOut = function(c) {
		b.fadeOut(c), a = !1
	}, this.play = function() {
		a || (a = !0, b.setVolume(100), b.play(), console.log("play"))
	}, this.pause = function() {
		a && (b.pause(), a = !1, console.log("pause"))
	}, this.setVolume = function(a) {
		b.setVolume(a)
	}
});